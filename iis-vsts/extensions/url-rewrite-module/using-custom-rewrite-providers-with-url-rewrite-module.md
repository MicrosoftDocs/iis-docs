...
In order to complete this walkthrough, download and install [URL Rewrite Extensibility Samples](https://www.microsoft.com/en-us/download/details.aspx?id=43353). The Extensibility Samples installation package includes .NET assemblies and the source code with full implementation of rewrite providers for the three most common use cases:
