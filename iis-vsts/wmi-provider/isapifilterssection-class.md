...
|Name|Description|  
|----------|-----------------|  
|`IsapiFilters`|An array of read/write [IsapiFilterElement](../wmi-provider/isapifilterelement-class.md) values that represent the ISAPI filters on a Web server.|  
