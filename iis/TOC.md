...
## [Introduction to IIS](get-started/introduction-to-iis/index.md)
...
## [Getting Started with IIS](get-started/getting-started-with-iis/index.md)
...
## [Planning Your IIS Architecture](get-started/planning-your-iis-architecture/index.md)
...
## [Planning for Security](get-started/planning-for-security/index.md)
...
## [Localized Content](get-started/localized-content/index.md)
...
## [Case Studies](get-started/case-studies/index.md)
...
## [What's New in IIS 8.5?](get-started/whats-new-in-iis-85/index.md)
...
## [What's New in IIS 8?](get-started/whats-new-in-iis-8/index.md)
...
## [What's New in IIS 7?](get-started/whats-new-in-iis-7/index.md)
...
## [Installing IIS 7](install/installing-iis-7/index.md)
...
## [Installing Publishing Technologies](install/installing-publishing-technologies/index.md)
...
## [Web Platform Installer](install/web-platform-installer/index.md)
...
## [Installing IIS 8.5](install/installing-iis-85/index.md)
...
## [Creating Websites](manage/creating-websites/index.md)
...
## [Provisioning and Managing IIS](manage/provisioning-and-managing-iis/index.md)
...
### [IIS 8 - Scaling for Multi-Tenant Hosting and Cloud](manage/provisioning-and-managing-iis/iis-8-scaling-for-multi-tenant-hosting-and-cloud.md)
### [Managing IIS Log File Storage](manage/provisioning-and-managing-iis/managing-iis-log-file-storage.md)
## [Configuring Security](manage/configuring-security/index.md)
...
## [Managing Performance Settings](manage/managing-performance-settings/index.md)
...
## [Managing your Configuration Settings](manage/managing-your-configuration-settings/index.md)
...
## [Scripting](manage/scripting/index.md)
...
## [PowerShell](manage/powershell/index.md)
...
## [Remote Administration](manage/remote-administration/index.md)
...
## [Working with Server Core](manage/working-with-server-core/index.md)
...
## [Runtime Extensibility](develop/runtime-extensibility/index.md)
...
## [Extending IIS Configuration](develop/extending-iis-configuration/index.md)
...
## [Extending the Management UI](develop/extending-the-management-ui/index.md)
...
## [Using Visual Studio with IIS](develop/using-visual-studio-with-iis/index.md)
### [Using Visual Studio 2005 with IIS 7.0](develop/using-visual-studio-with-iis/using-visual-studio-2005-with-iis.md)
## [Windows Web Application Gallery](develop/windows-web-application-gallery/index.md)
...
## [Installing/Publishing Apps with WebMatrix](develop/installingpublishing-apps-with-webmatrix/index.md)
...
## [Using WebMatrix](develop/using-webmatrix/index.md)
...
## [Troubleshooting WebMatrix](develop/troubleshooting-webmatrix/index.md)
...
## [Developing for FTP](develop/developing-for-ftp/index.md)
...
## [Deploying Application Packages](publish/deploying-application-packages/index.md)
...
## [Using Web Deploy](publish/using-web-deploy/index.md)
...
## [Troubleshooting Web Deploy](publish/troubleshooting-web-deploy/index.md)
...
## [Using WebDAV](publish/using-webdav/index.md)
...
## [Using the FTP Service](publish/using-the-ftp-service/index.md)
...
## [Installation Issues](troubleshoot/installation-issues/index.md)
...
## [Security Issues](troubleshoot/security-issues/index.md)
...
## [ASP.NET Issues](troubleshoot/aspnet-issues/index.md)
### [Troubleshooting Invalid viewstate issues](troubleshoot/aspnet-issues/troubleshooting-invalid-viewstate-issues.md)
## [Diagnosing HTTP Errors](troubleshoot/diagnosing-http-errors/index.md)
...
## [Using Failed Request Tracing](troubleshoot/using-failed-request-tracing/index.md)
...
## [Performance Issues](troubleshoot/performance-issues/index.md)
...
## [Remote Administration Issues](troubleshoot/remote-administration-issues/index.md)
...
## [Web Platform Installer Issues](troubleshoot/web-platform-installer-issues/index.md)
...
## [Planning for ARR](extensions/planning-for-arr/index.md)
...
## [Installing Application Request Routing (ARR)](extensions/installing-application-request-routing-arr/index.md)
...
## [Configuring Application Request Routing (ARR)](extensions/configuring-application-request-routing-arr/index.md)
...
## [Troubleshooting Application Request Routing](extensions/troubleshooting-application-request-routing/index.md)
...
## [URL Rewrite Module](extensions/url-rewrite-module/index.md)
...
## [Introduction to IIS Express](extensions/introduction-to-iis-express/index.md)
...
## [Using IIS Express](extensions/using-iis-express/index.md)
...
## [IIS Search Engine Optimization Toolkit](extensions/iis-search-engine-optimization-toolkit/index.md)
...
## [Advanced Logging Module](extensions/advanced-logging-module/index.md)
...
## [Database Manager](extensions/database-manager/index.md)
...
## [Working with UrlScan](extensions/working-with-urlscan/index.md)
...
## [HttpPlatformHandler](extensions/httpplatformhandler/index.md)
...
## [Windows Media Services](media/windows-media-services/index.md)
...
## [IIS Media Services](media/iis-media-services/index.md)
...
## [Smooth Streaming](media/smooth-streaming/index.md)
...
## [Live Smooth Streaming](media/live-smooth-streaming/index.md)
...
## [Live Smooth Streaming Events](media/live-smooth-streaming-events/index.md)
...
## [On-Demand Smooth Streaming](media/on-demand-smooth-streaming/index.md)
...
## [Streaming Media Conference Workshops](media/streaming-media-conference-workshops/index.md)
...
## [Bit Rate Throttling](media/bit-rate-throttling/index.md)
...
## [Transform Manager](media/transform-manager/index.md)
...
## [Web Playlists](media/web-playlists/index.md)
...
# [Application Frameworks](application-frameworks/index.md)
## [Building and Running ASP.NET Applications](application-frameworks/building-and-running-aspnet-applications/index.md)
...
## [Running Classic ASP Applications on IIS 7 and IIS 8](application-frameworks/running-classic-asp-applications-on-iis-7-and-iis-8/index.md)
...
## [Install and Configure PHP on IIS](application-frameworks/install-and-configure-php-on-iis/index.md)
...
## [Install and Configure PHP Applications on IIS](application-frameworks/install-and-configure-php-applications-on-iis/index.md)
...
## [Scenario: Build an ASP.NET Website on IIS](application-frameworks/scenario-build-an-aspnet-website-on-iis/index.md)
...
## [Scenario: Build a PHP Website on IIS](application-frameworks/scenario-build-a-php-website-on-iis/index.md)
...
# [Web Hosting](web-hosting/index.md)
## [Getting Started](web-hosting/getting-started/index.md)
...
## [Frequently Asked Questions (FAQ)](web-hosting/frequently-asked-questions-faq/index.md)
...
## [Migrate to the Microsoft Web Platform](web-hosting/migrate-to-the-microsoft-web-platform/index.md)
...
## [Configuring Components](web-hosting/configuring-components/index.md)
...
## [Planning the Web Hosting Architecture](web-hosting/planning-the-web-hosting-architecture/index.md)
...
## [Configuring Servers in the Windows Web Platform](web-hosting/configuring-servers-in-the-windows-web-platform/index.md)
...
## [Installing Infrastructure Components](web-hosting/installing-infrastructure-components/index.md)
...
## [Verifying the Deployment](web-hosting/verifying-the-deployment/index.md)
...
## [Web Server For Shared Hosting](web-hosting/web-server-for-shared-hosting/index.md)
...
## [Using Shared Hosting Environments](web-hosting/using-shared-hosting-environments/index.md)
...
## [Microsoft Web Farm Framework 2.0 for IIS 7](web-hosting/microsoft-web-farm-framework-20-for-iis-7/index.md)
...
## [Hosting the Microsoft Web Platform on Amazon EC2](web-hosting/hosting-the-microsoft-web-platform-on-amazon-ec2/index.md)
...
## [Hosting the Microsoft Web Platform on Windows Azure](web-hosting/hosting-the-microsoft-web-platform-on-windows-azure/index.md)
...
## [Joining the Web Hosting Gallery](web-hosting/joining-the-web-hosting-gallery/index.md)
...
## [Scenario: Build a Web Farm with IIS Servers](web-hosting/scenario-build-a-web-farm-with-iis-servers/index.md)
