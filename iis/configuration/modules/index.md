...
> [!NOTE]
> This collection of modules is specific to IIS Manager and should not be confused with the [&lt;SYSTEM.WEBSERVER modules&gt;](https://www.iis.net/configreference/system.webserver/modules) collection, which defines modules that affect HTTP request processing.
