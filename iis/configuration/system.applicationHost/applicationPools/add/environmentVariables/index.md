...
| Element | Description |
| --- | --- |
| [`add`](https://www.iis.net/configreference/system.applicationhost/applicationpools/add/environmentvariables/add) | Optional element. Adds an environment variable to the collection of environment variables. |
