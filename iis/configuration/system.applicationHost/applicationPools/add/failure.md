...
| `rapidFailProtectionMaxCrashes` | Optional uint attribute. Specifies the maximum number of failures that are allowed within the number of minutes specified by the **rapidFailProtectionInterval** attribute. > [!NOTE]
 > Starting in IIS 7.5 this value must be between 1 and 2147483647. The default value is `5`. |
