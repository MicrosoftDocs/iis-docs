...
| `managedRuntimeLoader` | Optional string attribute. Specifies the managed loader to use for pre-loading the application pool. <br><br>**Note:** This attribute was added in IIS 7.5. The default value is **webengine4.dll**. |
