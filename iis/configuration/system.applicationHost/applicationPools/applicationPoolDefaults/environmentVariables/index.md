...
| Element | Description |
| --- | --- |
| [`add`](../../../system.applicationhost/applicationpools/applicationpooldefaults/environmentvariables/add.md) | Optional element. Adds an environment variable to the collection of environment variables. |
