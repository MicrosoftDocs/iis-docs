...
For more information about how to configure application pools to start automatically, see the [`<applicationPools>`](../system.applicationhost/applicationpools/index.md) topic.
...
| Element | Description |
| --- | --- |
| [`add`](../system.applicationhost/serviceautostartproviders/add.md) | Optional element. Adds a provider to the collection of autostart providers. |
