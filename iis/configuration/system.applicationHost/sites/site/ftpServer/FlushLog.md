...
4. On the **Server Roles** page, expand **Web Server (IIS)**, and then select **FTP Server**.  
    ...
    ![Screenshot of Server Roles page with Web Server (I I S) expanded and F T P Server selected.](FlushLog/_static/image1.png) .
...
3. Expand **Internet Information Services**, and then select **FTP Server**.   
    ...
    ![Screenshot of Windows Features window with F T P Service and F T P Extensibility selected.](FlushLog/_static/image3.png)
4. Click **OK**.
5. Click **Close**.
...
5. Select **FTP Service**.  
    ...
    > [!NOTE]
    > To support ASP.Membership authentication or IIS Manager authentication for the FTP service, you will also need to select **FTP Extensibility**.  
    ![Screenshot of Select Role Services page with F T P Service selected in dialog box.](FlushLog/_static/image5.png)
6. Click **Next**.
...
4. Select **FTP Service**.  
    ...
    > [!NOTE]
    > To support ASP.Membership authentication or IIS Manager authentication for the FTP service, you will also need to select **FTP Extensibility**.   
    ![Screenshot of Windows Features window showing F T P Service selected.](FlushLog/_static/image7.png)
5. Click **OK**.
