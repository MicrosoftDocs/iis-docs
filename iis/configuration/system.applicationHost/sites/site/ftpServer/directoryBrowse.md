---
title: "FTP Directory Browse &lt;directoryBrowse&gt; | Microsoft Docs"
...
| --- | --- |
| `showFlags` | Optional flags attribute.<br><br>Specifies the options for directory listings. <table> <tbody> <tr> <td>Name</td> <td>Value</td></tr> <tr> <td><code>LongDate</code></td> <td>Specifies whether to show long dates or short dates.<br><br>The numeric value is <code>2</code>.</td></tr> <tr> <td><code>StyleUnix</code></td> <td>Specifies whether to display UNIX-style directory listings; otherwise, displays MSDOS-style listings.<br><br>The numeric value is <code>4</code>.</td></tr> <tr> <td><code>DisplayAvailableBytes</code></td> <td>Specifies whether to display the available bytes in directory listings.<br><br>The numeric value is <code>16</code>.</td></tr> <tr> <td><code>DisplayVirtualDirectories</code></td> <td>Specifies whether to display virtual directories if set; otherwise, virtual directories are hidden.<br><br>The numeric value is <code>32</code>.</td></tr> <tr> <td><code>UseGmtTime</code></td> <td>Specifies whether to display dates and times in GMT.<br><br>The numeric value is <code>64</code>.</td></tr></tbody></table>There is no default value. |
...
The following sample displays a `<directoryBrowse>` element for an FTP site that configures the FTP service to return UNIX-style directory listings, and to display both virtual directories and the available bytes in directory listings.
