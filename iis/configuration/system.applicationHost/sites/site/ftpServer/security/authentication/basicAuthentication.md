...
| `logonMethod` | Optional enum attribute.<br><br>Specifies the logon type for the user account that is logging in as interpreted by LogonUser Win32 API. <table> <tbody> <tr> <td>Value</td> <td>Description</td></tr> <tr> <td><code>Interactive</code></td> <td>Specifies the interactive logon type.<br><br>The numeric value is <code>0</code>.</td></tr> <tr> <td><code>Batch</code></td> <td>Specifies the batch logon type.<br><br>The numeric value is <code>1</code>.</td></tr> <tr> <td><code>Network</code></td> <td>Specifies the network logon type.<br><br>The numeric value is <code>2</code>.</td></tr> <tr> <td><code>ClearText</code></td> <td>Specifies the clear text logon type.<br><br>The numeric value is <code>3</code>.</td></tr></tbody></table>The default value is `ClearText`. |
