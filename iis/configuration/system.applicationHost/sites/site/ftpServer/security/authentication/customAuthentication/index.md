...
| Element | Description |
| --- | --- |
| [`providers`](https://www.iis.net/configreference/system.applicationhost/sites/site/ftpserver/security/authentication/customauthentication/providers) | Optional element. Specifies the collection of custom authentication providers. |
