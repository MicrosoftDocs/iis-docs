...
4. On the **Server Roles** page, expand **Web Server (IIS)**, and then select **FTP Server**.  
    ...
    [![Image of Server Roles page with Web Server I I S pane expanded and F T P Extensibility selected.](add/_static/image2.png)](add/_static/image1.png) .
...
3. Expand **Internet Information Services**, and then select **FTP Server**.   
    ...
    [![Screenshot of Internet Information Services pane expanded with F T P Extensibility selected.](add/_static/image4.png)](add/_static/image3.png)
4. Click **OK**.
5. Click **Close**.
...
5. Select **FTP Service**.  
    ...
    > [!NOTE]
    > To support ASP.Membership authentication or IIS Manager authentication for the FTP service, you will also need to select **FTP Extensibility**.  
    [![Screenshot of Select Role Services page with F T P Server pane expanded and F T P Service selected.](add/_static/image6.png)](add/_static/image5.png)
6. Click **Next**.
...
4. Select **FTP Service**.  
    ...
    > [!NOTE]
    > To support ASP.Membership authentication or IIS Manager authentication for the FTP service, you will also need to select **FTP Extensibility**.   
    [![Image of Internet Information Services and F T P Server expanded with F T P Extensibility selected.](add/_static/image8.png)](add/_static/image7.png)
5. Click **OK**.
...
4. Click the **Commands** tab.  
    [![Screenshot of the sites Home pane displaying the Commands tab.](add/_static/image10.png)](add/_static/image9.png)
...
7. Click **OK**.  
    [![Screenshot of Deny Command dialog box with S Y S T command populating the command box.](add/_static/image12.png)](add/_static/image11.png)
