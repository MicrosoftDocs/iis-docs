...
| Element | Description |
| --- | --- |
| [`add`](https://www.iis.net/configreference/system.applicationhost/sites/site/ftpserver/security/commandfiltering/add) | Optional element. Adds an entry to the collection of FTP commands. |
