...
4. On the **Server Roles** page, expand **Web Server (IIS)**, and then select **FTP Server**.  
    ...
    [![Image of Web Server I I S and F T P Server expanded with F T P Extensibility highlighted.](index/_static/image2.png)](index/_static/image1.png) .
...
5. Select **FTP Service**.  
    ...
    > [!NOTE]
    > To support ASP.Membership authentication or IIS Manager authentication for the FTP service, you will also need to select **FTP Extensibility**.  
    [![Image of F T P Service and F T P Extensibility both selected from the F T P Server expanded pane.](index/_static/image6.png)](index/_static/image5.png)
6. Click **Next**.
...
4. Select **FTP Service**.  
    ...
    > [!NOTE]
    > To support ASP.Membership authentication or IIS Manager authentication for the FTP service, you will also need to select **FTP Extensibility**.   
    [![Screenshot of F T P Extensibility selected from the F T P Server and Internet Information Services expanded pane.](index/_static/image8.png)](index/_static/image7.png)
5. Click **OK**.
...
5. In the **Actions** pane, click **Enable** to enable Anonymous authentication or click **Disable** to disable Anonymous authentication.  
    [![Image of F T P Authentication in the Actions pane displaying Anonymous Authentication disabled.](index/_static/image10.png)](index/_static/image9.png)
...
4. When the **Add FTP Site** wizard appears: 
    ...
    - When you have completed these items, click **Next**.  
        [![Image of Add F T P Site dialog box with My New F T P Site typed in F T P Site Name box.](index/_static/image12.png)](index/_static/image11.png)
5. On the second page of the **Add FTP Site** wizard: 
    ...
    - When you have completed these items, click **Next**.  
        [![Image of Binding and S S L Settings dialog box with I P Address box in Binding section.](index/_static/image14.png)](index/_static/image13.png)
6. On the next page of the wizard: 
    ...
    - When you have completed these items, click **Finish**.  
        [![Image of Authentication and Authorization settings displaying Anonymous option selected.](index/_static/image16.png)](index/_static/image15.png)
...
4. On the **FTP Authentication** page, select **Basic Authentication**.  
    [![Screenshot of F T P Authentication showing Anonymous Authentication and Basic Authentication options.](index/_static/image18.png)](index/_static/image17.png)
...
4. When the **Add FTP Site** wizard appears:
    ...
    - For the **Physical path** box, you can use one of the following options to specify your content directory: 
        ...
        - Type in the path to your content folder in the box. Note that if you choose to type the path, you can use environment variables in your paths. For example, you can use &quot;%*SystemDrive*%\inetpub\ftproot&quot; for your content directory.
    - When you have completed these items, click **Next**.  
        [![Image of Site Information on Add F T P Site Wizard displaying My New F T P Site typed in F T P site name field.](index/_static/image20.png)](index/_static/image19.png)
5. On the second page of the **Add FTP Site** wizard:
    ...
    - For the SSL options, choose one of the following options: 
        ...
        - If you choose **Allow SSL** or **Require SSL**, choose a certificate from the **SSL Certificate** drop-down menu.
    - When you have completed these items, click **Next**.   
        [![Image of Binding and S S L Settings in Add F T P Site Wizard showing the I P Address selected from teh drop down list.](index/_static/image22.png)](index/_static/image21.png)
6. On the next page of the wizard:
    ...
    - When you have completed these items, click **Finish**.  
        [![Screenshot of Authentication and Authorization settings in Add F T P Site Wizard with Basic option selected.](index/_static/image24.png)](index/_static/image23.png)
