...
4. On the **Server Roles** page, expand **Web Server (IIS)**, and then select **FTP Server**.  
    ...
    [![Screenshot shows Web Server I I S and F T P Server pane expanded with F T P Extensibility selected.](messages/_static/image2.png)](messages/_static/image1.png) .
...
3. Expand **Internet Information Services**, and then select **FTP Server**.   
    ...
    [![Screenshot of Internet Information Services and F T P Server pane expanded showing F T P Extensibility selected.](messages/_static/image4.png)](messages/_static/image3.png)
4. Click **OK**.
5. Click **Close**.
...
5. Select **FTP Service**.  
    ...
    > [!NOTE]
    > To support ASP.Membership authentication or IIS Manager authentication for the FTP service, you will also need to select **FTP Extensibility**.  
    [![Screenshot displays F T P Server pane in Select Role Services page expanded and F T P Service selected.](messages/_static/image6.png)](messages/_static/image5.png)
6. Click **Next**.
...
4. Select **FTP Service**.  
    ...
    > [!NOTE]
    > To support ASP.Membership authentication or IIS Manager authentication for the FTP service, you will also need to select **FTP Extensibility**.   
    [![Screenshot shows Internet Information Services and F T P Server node expanded with F T P Extensibility selected.](messages/_static/image8.png)](messages/_static/image7.png)
5. Click **OK**.
...
3. In the server's **Home** pane, double-click the **FTP Messages** feature.  
    [![Screenshot shows Home pane with F T P Messages feature selected.](messages/_static/image10.png)](messages/_static/image9.png)
4. Configure the following options: 
    ...
    - Type "Goodbye %UserName%!" for the **Exit** message.  
        [![Screenshot of F T P Messages page displaying Message Behavior section with Show detailed messages for local requests option selected.](messages/_static/image12.png)](messages/_static/image11.png)
