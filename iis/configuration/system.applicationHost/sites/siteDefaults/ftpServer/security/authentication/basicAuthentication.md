...
4. On the **Server Roles** page, expand **Web Server (IIS)**, and then select **FTP Server**.  
    ...
    [![Screenshot that shows F T P Extensibility selected for Windows Server 2012.](basicAuthentication/_static/image2.png)](basicAuthentication/_static/image1.png) .
...
3. Expand **Internet Information Services**, and then select **FTP Server**.   
    ...
    [![Screenshot that shows F T P Extensibility selected for Windows 8.](basicAuthentication/_static/image4.png)](basicAuthentication/_static/image3.png)
4. Click **OK**.
5. Click **Close**.
...
5. Select **FTP Service**.  
    ...
    > [!NOTE]
    > To support ASP.Membership authentication or IIS Manager authentication for the FTP service, you will also need to select **FTP Extensibility**.  
    [![Screenshot that shows F T P Extensibility selected for Windows Server 2008.](basicAuthentication/_static/image6.png)](basicAuthentication/_static/image5.png)
6. Click **Next**.
...
4. Select **FTP Service**.  
    ...
    > [!NOTE]
    > To support ASP.Membership authentication or IIS Manager authentication for the FTP service, you will also need to select **FTP Extensibility**.   
    [![Screenshot that shows F T P Extensibility selected for Windows 7.](basicAuthentication/_static/image8.png)](basicAuthentication/_static/image7.png)
5. Click **OK**.
...
4. On the **FTP Authentication** page, select **Basic Authentication**.  
    [![Screenshot that shows the F T P Authentication pane.](basicAuthentication/_static/image10.png)](basicAuthentication/_static/image9.png)
...
4. When the **Add FTP Site** wizard appears:
    ...
    - When you have completed these items, click **Next**.  
        [![Screenshot that shows the Add F T P Site dialog box for Site Information.](basicAuthentication/_static/image12.png)](basicAuthentication/_static/image11.png)
5. On the second page of the **Add FTP Site** wizard:
    ...
    - When you have completed these items, click **Next**.   
        [![Screenshot that shows the Add F T P Site dialog box for Binding and S S L Settings.](basicAuthentication/_static/image14.png)](basicAuthentication/_static/image13.png)
6. On the next page of the wizard:
    ...
    - When you have completed these items, click **Finish**.  
        [![Screenshot that shows the Add F T P Site dialog box for Authentication and Authorization Information.](basicAuthentication/_static/image16.png)](basicAuthentication/_static/image15.png)
