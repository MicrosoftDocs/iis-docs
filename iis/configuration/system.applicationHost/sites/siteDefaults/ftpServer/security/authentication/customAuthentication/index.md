---
title: "Default FTP Custom Authentication Settings &lt;customAuthentication&gt;"
author: rick-anderson
description: "Overview The &lt;customAuthentication&gt; element specifies the default settings for Custom authentication for FTP sites. This form of authentication uses cu..."
ms.date: 09/26/2016
ms.assetid: f8854fa3-d982-46de-99d9-03c0b20b2cdd
msc.legacyurl: /configreference/system.applicationhost/sites/sitedefaults/ftpserver/security/authentication/customauthentication
msc.type: config
---
...
The `<customAuthentication>` element specifies the default settings for Custom authentication for FTP sites. This form of authentication uses custom authentication providers to validate user names and passwords.
...
- ASP.NET Membership authentication: This uses an ASP.NET membership database to validate user names and passwords. For more information, see the [Configuring FTP with .NET Membership Authentication](https://learn.microsoft.com/iis/publish/using-the-ftp-service/configuring-ftp-with-net-membership-authentication-in-iis-7) topic on Microsoft's IIS.net Web site.
- IIS Manager authentication: This uses the IIS management user store to validate user names and passwords. For more information, see the [Configure FTP with IIS 7.0 Manager Authentication](https://learn.microsoft.com/iis/publish/using-the-ftp-service/configure-ftp-with-iis-manager-authentication-in-iis-7) topic Microsoft's IIS.net Web site.
...
4. On the **Server Roles** page, expand **Web Server (IIS)**, and then select **FTP Server**.  
    ...
    [![Screenshot that shows F T P Extensibility selected for Windows Server 2012.](index/_static/image2.png)](index/_static/image1.png) .
...
3. Expand **Internet Information Services**, and then select **FTP Server**.   
    ...
    [![Screenshot that shows F T P Extensibility selected for Windows 8.](index/_static/image4.png)](index/_static/image3.png)
4. Click **OK**.
5. Click **Close**.
...
4. Select **FTP Service**.  
    ...
    > [!NOTE]
    > To support ASP.Membership authentication or IIS Manager authentication for the FTP service, you will also need to select **FTP Extensibility**.   
    [![Screenshot that shows F T P Extensibility selected for Windows 7.](index/_static/image8.png)](index/_static/image7.png)
5. Click **OK**.
...
4. When the **FTP Authentication** page displays, click **Custom Providers...** in the **Actions** pane.  
    [![Screenshot that shows the F T P Authentication pane in the I I S Manager.](index/_static/image10.png)](index/_static/image9.png)
5. When the **Custom Providers** dialog box displays, click to select **IIS Manager Authentication**. Click **OK**.  
    [![Screenshot that shows the Custom Providers dialog box.](index/_static/image12.png)](index/_static/image11.png)
...
For additional information about how to configure IIS Manager authentication for FTP, see the [Configure FTP with IIS 7.0 Manager Authentication](https://learn.microsoft.com/iis/publish/using-the-ftp-service/configure-ftp-with-iis-manager-authentication-in-iis-7) topic on Microsoft's [www.iis.net/learn](https://www.iis.net/learn) Web site.
...
2. Add the extensibility provider to the global list of FTP authentication providers: 
    ...
    - Double-click **FTP Authentication** in the main window.  
        [![Screenshot that shows the F T P Authentication pane.](index/_static/image16.png)](index/_static/image15.png)
    - Click **Custom Providers...** in the **Actions** pane.
    - Click **Register**.  
        [![Screenshot that shows the Custom Providers dialog box. Two providers are listed.](index/_static/image18.png)](index/_static/image17.png)
    ...
    - Click **Managed Provider (.NET)**.  
        [![Screenshot that shows the Add Custom Authentication Provider dialog box.](index/_static/image20.png)](index/_static/image19.png)
