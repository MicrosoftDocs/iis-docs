---
title: "Adding Default FTP Custom Authentication Providers &lt;add&gt;"
...
4. On the **Server Roles** page, expand **Web Server (IIS)**, and then select **FTP Server**.  
    ...
    ![Screenshot of the F T P Extensibility option being highlighted and selected.](add/_static/image1.png) .
...
3. Expand **Internet Information Services**, and then select **FTP Server**.   
    ...
    ![Screenshot of the F T P Extensibility folder being highlighted and selected.](add/_static/image3.png)
4. Click **OK**.
5. Click **Close**.
...
5. Select **FTP Service**.  
    ...
    > [!NOTE]
    > To support ASP.Membership authentication or IIS Manager authentication for the FTP service, you will also need to select **FTP Extensibility**.  
    ![Screenshot of the Select Role Services wizard, showing the F T P Service option being highlighted and selected.](add/_static/image5.png)
6. Click **Next**.
...
4. Select **FTP Service**.  
    ...
    > [!NOTE]
    > To support ASP.Membership authentication or IIS Manager authentication for the FTP service, you will also need to select **FTP Extensibility**.   
    ![Screenshot of the Internet Information Service folder and its sub folders.](add/_static/image7.png)
5. Click **OK**.
...
4. When the **FTP Authentication** page displays, click **Custom Providers...** in the **Actions** pane.  
    ![Screenshot of the F T P Authentication page showing the Custom Providers option in the Actions pane.](add/_static/image9.png)
5. When the **Custom Providers** dialog box displays, click to select **IIS Manager Authentication**. Click **OK**.  
    ![Screenshot of the Custom Providers dialog box.](add/_static/image11.png)
...
2. Add the extensibility provider to the global list of FTP authentication providers: 
    ...
    - Double-click **FTP Authentication** in the main window.  
        ![Screenshot of the F T P Authentication screen.](add/_static/image15.png)
    - Click **Custom Providers...** in the **Actions** pane.
    - Click **Register**.  
        ![Screenshot of the Custom Providers dialog, showing the Register option.](add/_static/image17.png)
    ...
    - Click **Managed Provider (.NET)**.  
        ![Screenshot of the Add Custom Authentication Provider dialog, showing the Managed Provider dot NET option being selected.](add/_static/image19.png)
