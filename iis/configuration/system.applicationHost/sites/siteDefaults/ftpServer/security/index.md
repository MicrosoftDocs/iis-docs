...
5. Select **FTP Service**.  
    ...
    > [!NOTE]
    > To support ASP.Membership authentication or IIS Manager authentication for the FTP service, you will also need to select **FTP Extensibility**.  
    [![Statement that shows the FTP Service is selected.](index/_static/image6.png)](index/_static/image5.png)
6. Click **Next**.
...
5. In the **Actions** pane, click **Enable** to enable Anonymous authentication or click **Disable** to disable Anonymous authentication.  
    [![Statement that shows the FTP Authentication page. Anonymous Authentication is highlighted.](index/_static/image10.png)](index/_static/image9.png)
...
4. When the **Add FTP Site** wizard appears: 
    ...
    - When you have completed these items, click **Next**.  
        [![Statement that shows the Add FTP Site. Site Information is shown.](index/_static/image12.png)](index/_static/image11.png)
5. On the second page of the **Add FTP Site** wizard: 
    ...
    - When you have completed these items, click **Next**.  
        [![Statement that shows the Add FTP Site. Binding and SSL Settings is shown.](index/_static/image14.png)](index/_static/image13.png)
6. On the next page of the wizard: 
    ...
    - When you have completed these items, click **Finish**.  
        [![Statement that shows the Add FTP Site. Anonymous is selected under Authentication and Authorization settings.](index/_static/image16.png)](index/_static/image15.png)
...
4. On the **FTP Authentication** page, select **Basic Authentication**.  
    [![Statement that shows the FTP Authentication page.](index/_static/image18.png)](index/_static/image17.png)
...
4. When the **Add FTP Site** wizard appears:
    ...
    - For the **Physical path** box, you can use one of the following options to specify your content directory: 
        ...
        - Type in the path to your content folder in the box. Note that if you choose to type the path, you can use environment variables in your paths. For example, you can use &quot;%*SystemDrive*%\inetpub\ftproot&quot; for your content directory.
    - When you have completed these items, click **Next**.  
        [![Statement that shows the Add FTP Site wizard.](index/_static/image20.png)](index/_static/image19.png)
5. On the second page of the **Add FTP Site** wizard:
    ...
    - For the SSL options, choose one of the following options: 
        ...
        - If you choose **Allow SSL** or **Require SSL**, choose a certificate from the **SSL Certificate** drop-down menu.
    - When you have completed these items, click **Next**.   
        [![Statement that shows the Add FTP Site wizard. Binding and SSL Settings is shown.](index/_static/image22.png)](index/_static/image21.png)
6. On the next page of the wizard:
    ...
    - When you have completed these items, click **Finish**.  
        [![Statement that shows the Add FTP Site. Basic is selected under Authentication and Authorization.](index/_static/image24.png)](index/_static/image23.png)
