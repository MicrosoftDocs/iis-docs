...
> [!NOTE]
> When Dynamic site activation is enabled, users are not allowed to use an IP address to send a web request. For example, if users try to browse with HTTP://127.0.0.1, they will receive a 400 Bad Request Error.
