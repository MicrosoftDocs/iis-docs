...
| `flushInterval` | Optional uint attribute. Specifies the cache lifetime, in seconds, for credentials that are stored in the cache. > [!NOTE]
 > This value must be between 5 and 604,800 seconds. The default value is `900`. |
