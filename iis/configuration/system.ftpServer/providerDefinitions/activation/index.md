...
> [!NOTE]
> This element was added in FTP 7.5.
...
| Version | Notes |
| --- | --- |
| IIS 10.0 | The `<activation>` element was not modified in IIS 10.0. |
| IIS 8.5 | The `<activation>` element was not modified in IIS 8.5. |
| IIS 8.0 | The `<activation>` element was not modified in IIS 8.0. |
...
| Element | Description |
| --- | --- |
| [`providerData`](https://www.iis.net/configreference/system.ftpserver/providerdefinitions/activation/providerdata) | Optional element. Specifies the collection of key/value pairs that contain the data for a custom provider. |
