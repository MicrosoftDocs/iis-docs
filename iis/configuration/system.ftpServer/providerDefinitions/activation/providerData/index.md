...
The `<providerData>` element specifies the collection of key/value pairs that specify any parameters that a custom provider requires.
...
| Version | Notes |
| --- | --- |
| IIS 10.0 | The `<providerData>` element was not modified in IIS 10.0. |
| IIS 8.5 | The `<providerData>` element was not modified in IIS 8.5. |
| IIS 8.0 | The `<providerData>` element was not modified in IIS 8.0. |
| IIS 7.5 | The `<providerData>` element of the `<activation>` element ships as a feature of FTP 7.5. |
| IIS 7.0 | The `<providerData>` element of the `<activation>` element was not part of FTP 7.0. |
...
4. On the **Server Roles** page, expand **Web Server (IIS)**, and then select **FTP Server**.  
    ...
    [![Image of Server roles page with Web Server I I S expanded and F T P Extensibility selected from the pane.](index/_static/image2.png)](index/_static/image1.png) .
...
3. Expand **Internet Information Services**, and then select **FTP Server**.   
    ...
    [![Screenshot of Turn Windows Features on or off page with F T P Server pane expanded and F T P Extensibility highlighted.](index/_static/image4.png)](index/_static/image3.png)
4. Click **OK**.
5. Click **Close**.
...
5. Select **FTP Service**.  
    ...
    > [!NOTE]
    > To support ASP.Membership authentication or IIS Manager authentication for the FTP service, you will also need to select **FTP Extensibility**.  
    [![Image of Select Role Services page in Role Services section with F T P Server pane expanded and F T P Service selected.](index/_static/image6.png)](index/_static/image5.png)
6. Click **Next**.
...
The `<providerData>` element the `<activation>` element is configured at the global level in ApplicationHost.config.

### Attributes

| Attribute | Description |
| --- | --- |
| `name` | Required string attribute.<br><br>Specifies the friendly name of the custom provider.<br><br>**Note:** This name must match the name of a provider that is specified by a [`<providerDefinitions/add>`](../../add.md) element.<br><br>There is no default value. |

### Child Elements

| Element | Description |
| --- | --- |
| [`add`](add.md) | Optional element.<br><br>Adds a data entry for a custom provider. |
