...
| [`activation`](https://www.iis.net/configreference/system.ftpserver/providerdefinitions/activation) | Optional element. Specifies a collection of custom name/value pairs that define any parameters that a custom provider requires. > [!NOTE]
