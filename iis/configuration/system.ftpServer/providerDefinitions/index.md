...
4. On the **Server Roles** page, expand **Web Server (IIS)**, and then select **FTP Server**.  
    ...
    ![Screenshot of the Server Roles paage. F T P Extensibility is highlighted.](index/_static/image1.png) .
...
3. Expand **Internet Information Services**, and then select **FTP Server**.   
    ...
    ![Screenshot of the Windows Features dialog box. F T P Extensibility is highlighted.](index/_static/image3.png)
4. Click **OK**.
5. Click **Close**.
