...
| Element | Description |
| --- | --- |
| `[add](https://www.iis.net/configreference/system.ftpserver/security/ipsecurity/add)` | Optional element. Adds an IP restriction to the collection of IP address restrictions. |
