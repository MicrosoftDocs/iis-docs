...
| Element | Description |
| --- | --- |
| `[add](https://www.iis.net/configreference/system.ftpserver/security/requestfiltering/fileextensions/add)` | Optional element. Adds a file name extension to the collection of file name extensions. |
