...
| `partitionId` | Optional string attribute. Specifies the Globally Unique Identifier (GUID) of the COM+ partition. > [!NOTE]
 > This attribute is required when the **appServiceFlags** attribute is set to **UsePartition** The default value is `00000000-0000-0000-0000-000000000000`. |
| `sxsName` | Optional string attribute. > [!NOTE]
 > This attribute is required when the **appServiceFlags** attribute is set to **EnableSxS**. Specifies the name of the COM+ application. |
