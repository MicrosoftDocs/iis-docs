...
3. In the **Home** pane, scroll to **Output Caching**, and then double-click **Output Caching**.  
    ![Screenshot of Output Caching selected in the Default Web Site Home pane.](index/_static/image1.png)
...
6. Select the options that you want to use for caching, and then click **OK**.  
    ![Screenshot of the Add Cache Rule dialog with the specified options.](index/_static/image3.png)
