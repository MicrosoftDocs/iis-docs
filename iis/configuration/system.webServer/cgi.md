...
> [!NOTE]
> The CGI environment is not installed by default; however, installing the CGI environment also installs the necessary functionality for using FastCGI applications. For more information about using FastCGI on IIS 7, see the [&lt;fastCgi&gt;](../system.webserver/fastcgi/index.md) element.
