...
4. On the **Server Roles** page, expand **Web Server (IIS)**, expand **Web Server**, expand **Application Development**, and then select **CGI**. Click **Next**.  
    ![Screenshot that shows C G I selected for Windows Server 2012.](environmentVariable/_static/image1.png)
...
3. Expand **Internet Information Services**, expand **World Wide Web Services**, expand **Application Development Features**, and then select **CGI**.  
    ![Screenshot that shows C G I selected for Windows 8.](environmentVariable/_static/image3.png)
4. Click **OK**.
5. Click **Close**.
...
4. On the **Select Role Services** page of the **Add Role Services Wizard**, select **CGI**, and then click **Next**.  
    ![Screenshot that shows the Select Role Services page in the Add Role Services dialog box for Windows Server 2008. C G I is selected.](environmentVariable/_static/image5.png)
...
3. Expand **Internet Information Services**, then select **CGI**, and then click **OK**.  
    ![Screenshot that shows C G I selected for Windows Vista or Windows 7.](environmentVariable/_static/image7.png)
...
3. In the **Home** pane, double-click **Handler Mappings**.  
   ![Screenshot that shows the Default Web Site Home pane, with Handler Mappings selected.](environmentVariable/_static/image9.png)
4. In the **Actions** pane, click **Add Module Mapping**.  
   ![Screenshot that shows the Handler Mappings pane.](environmentVariable/_static/image11.png)
5. Enter the following information:
   ...
   ![Screenshot that shows the Add Module Mapping dialog box.](environmentVariable/_static/image13.png)
   ...
   - Click **OK**.
      ...
      ![Screenshot that shows the Request Restrictions dialog box, with File or Folder selected.](environmentVariable/_static/image15.png)

- Click **OK**.
- If you are prompted to create a FastCGI application in the **Add Module Mapping** dialog box, click **Yes**.  
    ![Screenshot that shows the Add Module Mapping message box.](environmentVariable/_static/image17.png)
...
3. In the **Home** pane, double-click **FastCGI Settings**.  
    ![Screenshot that shows the SERVER Home pane, with Fast C G I Settings selected.](environmentVariable/_static/image19.png)
4. In the **Actions** pane, click **Add Application...**  
    ![Screenshot that shows the Fast C G I Settings pane.](environmentVariable/_static/image21.png)
5. In the **Add FastCGI Application** dialog box, enter the following information:
   ...
   ![Screenshot that shows the Add Fast C G I Application dialog box.](environmentVariable/_static/image23.png)
...
7. In the **EnvironmentVariables Collection Editor** dialog box, click **Add**.  
    ![Screenshot that shows the Environment Variables Collection Editor dialog box.](environmentVariable/_static/image25.png)
8. Enter the following information, and then click **OK**:

   - Enter "PHP\_FCGI\_MAX\_REQUESTS" for the **Name**.
   - Enter "10000" for the **Value**.
  
   ![Screenshot that shows the Environment Variables Collection Editor dialog box with one entry under Members.](environmentVariable/_static/image27.png)
...
2. In the **Connections** pane, click the server name for which you want to configure FastCGI settings.
3. In the **Home** pane, double-click **FastCGI Settings**.  
    ![Screenshot that shows the SERVER Home pane. Fast C G I Settings is selected.](environmentVariable/_static/image29.png)
4. Highlight the PHP application in the **FastCGI Settings** pane, then click **Edit...** in the **Actions** pane.  
    ![Screenshot that shows the Fast C G I Settings pane, with p h p dot e x e listed under Full Path.](environmentVariable/_static/image31.png)
5. In the **Edit FastCGI Application** dialog box, click the ellipsis (**...**) next to **EnvironmentVariables** to open the environment variables collection editor.  
    ![Screenshot that shows the Edit Fast C G I Application dialog box.](environmentVariable/_static/image33.png)
6. In the **EnvironmentVariables Collection Editor** dialog box, click **Add**.  
    ![Screenshot that shows the Environment Variables Collection Editor dialog box with empty fields.](environmentVariable/_static/image35.png)
7. Enter the following information, and then click **OK**:

   - Enter "PHP\_FCGI\_MAX\_REQUESTS" for the **Name**.
   - Enter "10000" for the **Value**.
  
      ![Screenshot that shows the Environment Variables Collection Editor dialog box with 1 entry under Members.](environmentVariable/_static/image37.png)
