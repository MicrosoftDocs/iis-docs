...
| Element | Description |
| --- | --- |
| [`application`](../system.webserver/fastcgi/application/index.md) | Optional element. Adds a FastCGI process pool definition to the collection of FastCGI process pool definitions. |
