...
3. On the server Home page, double-click **Modules**.  
    [![Screenshot that shows the Modules is highlighted.](add/_static/image2.png)](add/_static/image1.png)
4. In the **Actions** pane, click **Configure Native Modules...**
5. In the **Configure Native Modules** dialog box, click **Register...**  
    [![Screenshot that shows the Configure Native Modules dialog box.](add/_static/image4.png)](add/_static/image3.png)
...
7. In the **Path** box, type the file system path of the location of the .dll file or click the **Browse** button  
    [![Screenshot that shows the Register Native Module dialog box.](add/_static/image6.png)](add/_static/image5.png)
...
5. In the **Configure Native Modules** dialog box, select the option for the native module that you want to enable, and then click **OK**.  
    [![Screenshot that shows the Configure Native Modules dialog box. UriCacheModule is selected.](add/_static/image8.png)](add/_static/image7.png)
