...
| Element | Description |
| --- | --- |
| [`add`](https://www.iis.net/configreference/system.webserver/httpredirect/add) | Optional element. Adds a wildcard redirection rule to the collection of redirection rules. |
