...
4. On the **Server Roles** page, expand **Web Server (IIS)**, expand **Management Tools**, and then select **Management Service**. Click **Next**.  
    [![Screenshot of the Server Roles page with the Management Service option being highlighted.](index/_static/image2.png)](index/_static/image1.png) .
...
3. Expand **Internet Information Services**, expand **Web Management Tools**, and then select **IIS Management Service**.  
    [![Screenshot of the Web Management Tools folder being expanded with the I I S Management Service folder being highlighted.](index/_static/image4.png)](index/_static/image3.png)
4. Click **OK**.
5. Click **Close**.
...
4. On the **Select Role Services** page of the **Add Role Services Wizard**, select **Management Service**, and then click **Next**.  
    [![Screenshot of the Management Service option being highlighted.](index/_static/image6.png)](index/_static/image5.png)
...
4. Select **IIS Management Service**, and then click **OK**.   
    [![Screenshot of the Management Service screen with the Enable Remote connections option selected.](index/_static/image8.png)](index/_static/image7.png)
...
3. In the server's **Home** pane, double-click **Management Service**.  
    [![Screenshot of the Home pane with the Management Service option being highlighted.](index/_static/image10.png)](index/_static/image9.png)
4. On the **Management Service** page, choose **Windows credentials or IIS Manager credentials**, then click **Apply** in the **Actions** pane.  
    [![Screenshot of the Identity Credentials section with the Windows credentials or I I S Manager credentials option being selected.](index/_static/image12.png)](index/_static/image11.png)
...
3. In the server's **Home** pane, double-click **IIS Manager Users**.  
    [![Screenshot of the I I S Manager Users icon in the Home pane being highlighted.](index/_static/image14.png)](index/_static/image13.png)
4. On the **IIS Manager Users** page, click **Add User...** in the **Actions** pane.  
    [![Screenshot of the I I S Manager Users page.](index/_static/image16.png)](index/_static/image15.png)
5. In the **Add User** dialog box, enter the user name and password, and then click **OK**.  
    [![Screenshot of the Add User dialog box, showing the User Name, Password, and Confirm password fields.](index/_static/image18.png)](index/_static/image17.png)
