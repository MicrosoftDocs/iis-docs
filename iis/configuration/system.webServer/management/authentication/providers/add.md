...
| --- | --- |
| `name` | Required string attribute. Specifies the name of the authentication provider. |
| `type` | Required string attribute. Specifies the managed type of the authentication provider. |
