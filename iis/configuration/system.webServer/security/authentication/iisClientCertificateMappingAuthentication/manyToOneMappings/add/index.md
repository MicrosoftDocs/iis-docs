...
| `permissionMode` | Optional enum attribute. <br><br>The permissionMode attribute can be one of the following possible values. The default is `Allow`. <table> <tbody> <tr> <td>Value</td> <td>Description</td></tr> <tr> <td><code>Allow</code></td> <td>Specifies that clients with a matching client certificate should be allowed permission to authenticate.<br><br>The numeric value is <code>1</code>. </td></tr> <tr> <td><code>Deny</code></td> <td>Specifies that clients with a matching client certificate should be denied permission to authenticate.<br><br>The numeric value is <code>2</code>. </td></tr></tbody></table> |
