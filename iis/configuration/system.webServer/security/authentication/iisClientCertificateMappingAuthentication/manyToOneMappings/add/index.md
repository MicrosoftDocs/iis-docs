...
4. On the **Server Roles** page, expand **Web Server (IIS)**, expand **Web Server**, expand **Security**, and then select **IIS Client Certificate Mapping Authentication**. Click **Next**.  
    [![Image of Web Server and Security pane expanded and I I S Client Certificate Mapping Authentication selected.](index/_static/image2.png)](index/_static/image1.png) .
...
3. Expand **Internet Information Services**, expand **World Wide Web Services**, expand **Security**, and then select **IIS Client Certificate Mapping Authentication**.  
    [![Screenshot of World Wide Web Services and Security pane expanded and I I S Client Certificate Mapping Authentication selected.](index/_static/image4.png)](index/_static/image3.png)
4. Click **OK**.
5. Click **Close**.
...
4. On the **Select Role Services** page of the **Add Role Services Wizard**, select **IIS Client Certificate Mapping Authentication**, and then click **Next**.  
    [![Image of Select Role Services page with I I S Client Certificate Mapping Authentication Selected.](index/_static/image6.png)](index/_static/image5.png)
...
3. Expand **Internet Information Services**, then select **IIS Client Certificate Mapping Authentication**, and then click **OK**.  
    [![Screenshot of Internet Information Services pane expanded and I I S Client Certificate Mapping Authentication highlighted.](index/_static/image8.png)](index/_static/image7.png)
