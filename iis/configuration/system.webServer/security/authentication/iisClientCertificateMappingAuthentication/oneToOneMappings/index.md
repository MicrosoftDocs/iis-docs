...
4. On the **Server Roles** page, expand **Web Server (IIS)**, expand **Web Server**, expand **Security**, and then select **IIS Client Certificate Mapping Authentication**. Click **Next**.  
    [![Screenshot that shows I I S Client Certificate Mapping Authentication selected for Windows Server 2012.](index/_static/image2.png)](index/_static/image1.png) .
...
3. Expand **Internet Information Services**, expand **World Wide Web Services**, expand **Security**, and then select **IIS Client Certificate Mapping Authentication**.  
    [![Screenshot that shows I I S Client Certificate Mapping Authentication selected for Windows 8.](index/_static/image4.png)](index/_static/image3.png)
4. Click **OK**.
5. Click **Close**.
...
4. On the **Select Role Services** page of the **Add Role Services Wizard**, select **IIS Client Certificate Mapping Authentication**, and then click **Next**.  
    [![Screenshot that shows I I S Client Certificate Mapping Authentication selected for Windows Server 2008.](index/_static/image6.png)](index/_static/image5.png)
...
3. Expand **Internet Information Services**, then select **IIS Client Certificate Mapping Authentication**, and then click **OK**.  
    [![Screenshot that shows I I S Client Certificate Mapping Authentication selected for Windows Vista or Windows 7.](index/_static/image8.png)](index/_static/image7.png)
