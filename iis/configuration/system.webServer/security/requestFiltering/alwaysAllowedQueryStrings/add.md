...
4. On the **Server Roles** page, expand **Web Server (IIS)**, expand **Web Server**, expand **Security**, and then select **Request Filtering**. Click **Next**.  
    [![Screenshot that shows the Request Filtering Installed selected.](add/_static/image2.png)](add/_static/image1.png) .
...
3. Expand **Internet Information Services**, expand **World Wide Web Services**, expand **Security**, and then select **Request Filtering**.  
    [![Screenshot that shows the Request Filtering services selected.](add/_static/image4.png)](add/_static/image3.png)
4. Click **OK**.
5. Click **Close**.
...
4. On the **Select Role Services** page of the **Add Role Services Wizard**, select **Request Filtering**, and then click **Next**.   
    [![Screenshot that shows the Request Filtering selected.](add/_static/image6.png)](add/_static/image5.png)
...
4. Select **Request Filtering**, and then click **OK**.   
    [![Screenshot that shows the Request Filtering is selected.](add/_static/image8.png)](add/_static/image7.png)
