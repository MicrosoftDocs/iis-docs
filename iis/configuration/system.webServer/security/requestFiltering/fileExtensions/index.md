...
| Element | Description |
| --- | --- |
| [`add`](../../../system.webserver/security/requestfiltering/fileextensions/add.md) | Optional element. Adds a file name extension to the collection of file name extensions. |
