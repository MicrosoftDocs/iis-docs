...
| Element | Description |
| --- | --- |
| [`add`](../../../../../system.webserver/security/requestfiltering/filteringrules/filteringrule/appliesto/add.md) | Optional element. Adds a file name extension to the list of file name extensions for a filtering rule. |
