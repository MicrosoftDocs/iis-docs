...
4. On the **Server Roles** page, expand **Web Server (IIS)**, expand **Web Server**, expand **Security**, and then select **Request Filtering**. Click **Next**.  
    [![Screenshot that shows Request Filtering selected and highlighted, under the Security node.](add/_static/image2.png)](add/_static/image1.png) .
...
3. Expand **Internet Information Services**, expand **World Wide Web Services**, expand **Security**, and then select **Request Filtering**.  
    [![Screenshot that shows Request Filtering selected and highlighted, under the Security node for Windows 8.](add/_static/image4.png)](add/_static/image3.png)
4. Click **OK**.
5. Click **Close**.
...
4. On the **Select Role Services** page of the **Add Role Services Wizard**, select **Request Filtering**, and then click **Next**.   
    [![Screenshot that shows Request Filtering selected and highlighted, under the Security node for Windows Server 2008.](add/_static/image6.png)](add/_static/image5.png)
...
4. Select **Request Filtering**, and then click **OK**.   
    [![Screenshot that shows Request Filtering selected and highlighted, under the Security node for Windows Vista or Windows 7.](add/_static/image8.png)](add/_static/image7.png)
...
4. In the **Request Filtering** pane, click the **Rules** tab.  
    [![Screenshot that shows the Request Filtering pane. The Rules tab is selected.](add/_static/image10.png)](add/_static/image9.png)
...
6. Enter the following information for the filtering rule in the **Add Filtering Rule** dialog: 
    ...
    - Enter the collection of strings to deny for the filtering rule in the **Deny Strings** collection.  
        [![Screenshot that shows Add Filtering Rule window. Scan u r l and Scan query string are both selected.](add/_static/image12.png)](add/_static/image11.png)
