...
| Element | Description |
| --- | --- |
| [`add`](https://www.iis.net/configreference/system.webserver/security/requestfiltering/filteringrules/filteringrule/scanheaders/add) | Optional element. Adds a unique HTTP header to the collection of HTTP headers which a request filtering rule will scan. |
