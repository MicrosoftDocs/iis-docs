---
title: "Hidden Segments &lt;hiddenSegments&gt;"
...
4. On the **Server Roles** page, expand **Web Server (IIS)**, expand **Web Server**, expand **Security**, and then select **Request Filtering**. Click **Next**.  
    [![Screenshot that shows Request Filtering selected for Windows Server 2012.](index/_static/image2.png)](index/_static/image1.png) .
...
3. In the **Home** pane, double-click **Request Filtering**.   
    [![Screenshot that shows the Default Web Site Home pane. Request Filtering is selected.](index/_static/image10.png)](index/_static/image9.png)
4. In the **Request Filtering** pane, click the **Hidden Segments** tab, and then click **Add Hidden Segment...** in the **Actions** pane.   
    [![Screenshot that shows the Request Filtering pane.](index/_static/image12.png)](index/_static/image11.png)
5. In the **Add Hidden Segment** dialog box, enter the relative path that you want to hide, and then click **OK**.   
    [![Screenshot that shows the Add Hidden Segment dialog box. Underscore private is entered into the Hidden segment text box.](index/_static/image14.png)](index/_static/image13.png)
