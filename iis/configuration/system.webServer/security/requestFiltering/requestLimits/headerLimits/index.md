...
4. On the **Server Roles** page, expand **Web Server (IIS)**, expand **Web Server**, expand **Security**, and then select **Request Filtering**. Click **Next**.  
    [![Screenshot of Web Server and Security node expanded displaying Request Filtering selected.](index/_static/image2.png)](index/_static/image1.png) .
...
3. Expand **Internet Information Services**, expand **World Wide Web Services**, expand **Security**, and then select **Request Filtering**.  
    [![Screenshot of World Wide Web Services and Security pane expanded with Request Filtering selected.](index/_static/image4.png)](index/_static/image3.png)
4. Click **OK**.
5. Click **Close**.
...
4. On the **Select Role Services** page of the **Add Role Services Wizard**, select **Request Filtering**, and then click **Next**.   
    [![Screenshot of Select Role Services page displaying Security node expanded and Request Filtering selected.](index/_static/image6.png)](index/_static/image5.png)
...
4. Select **Request Filtering**, and then click **OK**.   
    [![Screenshot of Internet Information Services and Security pane expanded showing Request Filtering highlighted.](index/_static/image8.png)](index/_static/image7.png)
...
3. In the **Home** pane, double-click **Request Filtering**.   
    [![Screenshot of Default Web Site Home with Request Filtering selected.](index/_static/image10.png)](index/_static/image9.png)
4. In the **Request Filtering** pane, click the **Headers** tab, and then click **Add Header...** in the **Actions** pane.   
    [![Screenshot of Request Filtering pane and Headers tab with Add Header displayed in the Actions pane.](index/_static/image12.png)](index/_static/image11.png)
5. In the **Add Header** dialog box, enter the HTTP header and the maximum size that you want for the header limit, and then click **OK**.   
    [![Screenshot of Add Header dialog box showing fields for Header and Size limit.](index/_static/image14.png)](index/_static/image13.png)
