...
| `maxRequestEntityAllowed` | Optional uint attribute.<br><br>Specifies the maximum number of bytes that can be in an entity body of a request. If the Content-Length header specifies a larger number, IIS sends an HTTP 403 error response.<br><br>The default value is `4294967295` (unlimited). |
