...
The `<clientCache>` element of the [`<staticContent>`](../../system.webserver/staticcontent.md) element specifies cache-related HTTP headers that IIS 7 and later sends to Web clients, which control how Web clients and proxy servers will cache the content that IIS 7 and later returns.
