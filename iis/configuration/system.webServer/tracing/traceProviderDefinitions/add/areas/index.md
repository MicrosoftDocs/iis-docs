...
3. Expand **Internet Information Services**, expand **World Wide Web Services**, expand **Health and Diagnostics**, and then select **Tracing**.  
    [![Image of World Wide Web Services nd Health and Diagnostics pane expanded with Tracing selected.](index/_static/image4.png)](index/_static/image3.png)- Click **OK**.
4. Click **Close**.
