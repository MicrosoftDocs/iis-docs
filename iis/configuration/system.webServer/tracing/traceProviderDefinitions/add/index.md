...
4. On the **Server Roles** page, expand **Web Server (IIS)**, expand **Web Server**, expand **Health and Diagnostics**, and then select **Tracing**. Click **Next**.  
    ![Screenshot of the Roles and Features wizard. Tracing is highlighted in the menu.](index/_static/image1.png) .
...
3. Expand **Internet Information Services**, expand **World Wide Web Services**, expand **Health and Diagnostics**, and then select **Tracing**.  
    ![Screenshot of the Windows Features dialog box. Tracing is highlighted in the expanded menu.](index/_static/image3.png)- Click **OK**.
4. Click **Close**.
...
4. On the **Select Role Services** page of the **Add Role Services Wizard**, select **Tracing**, and then click **Next**.  
    ![Screenshot of the Select Role Services wizard displaying the Role Service page. Tracing is highlighted in the expanded menu.](index/_static/image5.png)
...
4. Select **Tracing**, and then click **OK**.  
    ![Screenshot of the Windows Features dialog box with the Tracing feature is highlighted.](index/_static/image7.png)
