...
| `hideChildVirtualDirectories` | Optional **Boolean** attribute. **true** if virtual directories are hidden from WebDAV requests; otherwise, **false**. <br><br>**Note:** This attribute was added in WebDAV 7.5 and IIS 7.5. The default value is `false`. |
