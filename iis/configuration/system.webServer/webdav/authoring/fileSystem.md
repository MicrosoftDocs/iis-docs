...
4. On the **Server Roles** page, expand **Web Server (IIS)**, expand **Web Server**, expand **Common HTTP Features**, and then select **WebDAV Publishing**. Click **Next**.  
    ![Screenshot shows Web Server and Common H T T P Features pane expanded with Web DAV Publishing selected.](fileSystem/_static/image1.png)
...
3. Expand **Internet Information Services**, expand **World Wide Web Services**, expand **Common HTTP Features**, and then select **WebDAV Publishing**.  
    ![Screenshot of Common H T T P Features pane in Turn Windows features on or off page displaying Web DAV Publishing selected.](fileSystem/_static/image3.png)
4. Click **OK**.
5. Click **Close**.
...
4. On the **Select Role Services** page of the **Add Role Services Wizard**, expand **Common HTTP Features**, select **WebDAV Publishing**, and then click **Next**.   
    ![Screenshot shows Select Role Services page in Add Role Services Wizard with Web DAV Publishing selected from Common H T T P Features pane.](fileSystem/_static/image5.png)
...
4. Select **WebDAV Publishing**, and then click **OK**.  
    ![Screenshot displays Common H T T P Features pane expanded and Web DAV Publishing selected.](fileSystem/_static/image7.png)
...
3. In the **Home** pane, double-click **WebDAV Authoring Rules**.  
    ![Screenshot of Web DAV Authoring Rules feature in Home pane. Web DAV Settings is displayed in Actions pane.](fileSystem/_static/image9.png)
...
5. In the **WebDAV Settings** pane, choose select **True** for **Allow Hidden Files to be Listed** if you want properties for hidden files to be returned in property responses; otherwise, choose **False**.  
    ![Screenshot of Web DAV Settings pane With Allow Hidden Files to be Listed option set to True. Apply option is shown in the Actions pane.](fileSystem/_static/image11.png)
