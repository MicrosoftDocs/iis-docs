...
4. On the **Select Role Services** page of the **Add Role Services Wizard**, expand **Common HTTP Features**, select **WebDAV Publishing**, and then click **Next**.   
    ![Screenshot that shows Web DAV Publishing selected for Windows Server 2008 in the Add Role Services wizard.](index/_static/image5.png)
...
3. In the site's **Home** pane, double-click **WebDAV Authoring Rules**.  
    ![Screenshot that shows the Server Home pane, with Web DAV Authoring Rules selected.](index/_static/image9.png)
...
5. When the **WebDAV Settings** page is displayed, specify the following options in the **Lock Behavior** section:
    ...
    - Set **Require Lock for Writing** to your desired setting.  
        ![Screenshot that shows the Web DAV Settings pane.](index/_static/image11.png)
...
3. In the site's **Home** pane, double-click **WebDAV Authoring Rules**.  
    ![Screenshot that shows the Default Web Site Home pane. Web DAV is selected.](index/_static/image13.png)
4. When the **WebDAV Authoring Rules** page is displayed, click **WebDAV Settings** in the **Actions** pane.  
    ![Screenshot that shows the Web DAV Authoring Rules pane.](index/_static/image15.png)
5. When the **WebDAV Settings** page is displayed, specify the following options in the **Property Behavior** section: 
   ...
   - Set **Allow property queries with infinite depth** to **False**.
     ...
     ![Screenshot that shows the Web DAV Settings pane. Three fields have been changed.](index/_static/image17.png)
6. Click the ellipsis (**...**) button to launch the Namespace Collection Editor.   
    ![Screenshot that shows the Namespace Collection Editor dialog box.](index/_static/image19.png)
