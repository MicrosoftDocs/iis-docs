...
3. Expand **Internet Information Services**, expand **World Wide Web Services**, expand **Common HTTP Features**, and then select **WebDAV Publishing**.  
    ![Screenshot of Turn Windows Features on or off page displaying Common H T T P Features pane expanded and Web DAV Publishing selected.](add/_static/image3.png)
4. Click **OK**.
5. Click **Close**.
...
4. On the **Select Role Services** page of the **Add Role Services Wizard**, expand **Common HTTP Features**, select **WebDAV Publishing**, and then click **Next**.   
    ![Image of Select Role Services page with Common H T T P Features pane expanded and Web DAV Publishing selected.](add/_static/image5.png)
...
4. Select **WebDAV Publishing**, and then click **OK**.   
    ![Screenshot of Windows Feature page displaying World Wide Web Services and Common H T T P Features pane expanded with Web DAV Publishing selected.](add/_static/image7.png)
...
3. In the site's **Home** pane, double-click **WebDAV Authoring Rules**.  
    ![Screenshot of Server Home control panel with Web DAV Publishing highlighted.](add/_static/image9.png)
...
5. When the **WebDAV Settings** page is displayed, specify the following options in the **Lock Behavior** section:
    ...
    - Set **Require Lock for Writing** to your desired setting.  
        ![Screenshot of Web DAV Settings page with Lock Behavior section displayed.](add/_static/image11.png)
