...
| Element | Description |
| --- | --- |
| `[add](https://www.iis.net/configreference/system.webserver/webdav/globalsettings/lockstores/add)` | Optional element. Specifies the settings for a lock store provider. |
