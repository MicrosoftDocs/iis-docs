---
title: "Adding WebDAV Property Stores &lt;add&gt;"
...
4. On the **Server Roles** page, expand **Web Server (IIS)**, expand **Web Server**, expand **Common HTTP Features**, and then select **WebDAV Publishing**. Click **Next**.  
    ![Screenshot that shows the Web Server expanded on the Server Roles page. WebDAV Publishing is selected.](add/_static/image1.png)
...
4. On the **Select Role Services** page of the **Add Role Services Wizard**, expand **Common HTTP Features**, select **WebDAV Publishing**, and then click **Next**.   
    ![Screenshot that shows the Add Role Services page. WebDAV Publishing is selected.](add/_static/image5.png)
...
4. Select **WebDAV Publishing**, and then click **OK**.   
    ![Screenshot that shows the Windows Features pane. WebDAV Publishing is selected.](add/_static/image7.png)
...
3. In the site's **Home** pane, double-click **WebDAV Authoring Rules**.  
    ![Screenshot that shows the Internet Information Services Manager pane. WebDAV Authoring Rules is selected on Default Web Site Home pane.](add/_static/image9.png)
4. When the **WebDAV Authoring Rules** page is displayed, click **WebDAV Settings** in the **Actions** pane.  
    ![Screenshot that shows the Internet Information Services Manager pane. WebDAV Authoring Rules page is displayed.](add/_static/image11.png)
5. When the **WebDAV Settings** page is displayed, specify the following options in the **Property Behavior** section: 
   ...
   - Set **Allow property queries with infinite depth** to **False**.
     ...
     ![Screenshot that shows the Internet Information Services Manager pane. Default Web Site is WebDAV Settings.](add/_static/image13.png)
6. Click the ellipsis (**...**) button to launch the Namespace Collection Editor.   
    ![Screenshot that shows the Name Space Collection Editor dialog box.](add/_static/image15.png)
