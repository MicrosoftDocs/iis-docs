...
3. Expand **Internet Information Services**, expand **World Wide Web Services**, expand **Common HTTP Features**, and then select **WebDAV Publishing**.  
    ![Screenshot shows Windows Features dialog box selecting Web D A V Publishing checkbox.](index/_static/image3.png)
4. Click **OK**.
5. Click **Close**.
...
3. In the site's **Home** pane, double-click **WebDAV Authoring Rules**.  
    ![Screenshot shows I I S Manager window home page selecting Web D A V authoring Rules icon.](index/_static/image9.png)
...
6. Click the ellipsis (**...**) button to launch the Namespace Collection Editor.   
    ![Screenshot shows the Name space Collection editor to add Properties.](index/_static/image15.png)
