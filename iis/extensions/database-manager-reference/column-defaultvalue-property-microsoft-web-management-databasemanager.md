...
ms:contentKeyID: 20476434
ms.date: 05/02/2012
mtps_version: v=VS.90
f1_keywords:
- Microsoft.Web.Management.DatabaseManager.Column.DefaultValue
...
Gets or sets the default value for the database column.
...
The range of possible default values for a database column is dependent upon the type of data that is stored in the column. To determine the list of possible default values, consult the schema documentation for your database.
