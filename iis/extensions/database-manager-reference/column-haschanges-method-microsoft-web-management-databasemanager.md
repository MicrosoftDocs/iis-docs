...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.web.management.databasemanager.column.haschanges(v=VS.90)
...
Retrieves whether the column has specific changes.
