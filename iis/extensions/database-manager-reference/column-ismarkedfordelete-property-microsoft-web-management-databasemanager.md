...
f1_keywords:
- Microsoft.Web.Management.DatabaseManager.Column.IsMarkedForDelete
- Microsoft.Web.Management.DatabaseManager.Column.get_IsMarkedForDelete
- Microsoft.Web.Management.DatabaseManager.Column.set_IsMarkedForDelete
dev_langs:
- csharp
- jscript
- vb
...
# Column.IsMarkedForDelete Property

Gets or sets a value that indicates whether the database column is marked for deletion.
...
true if the column is marked for deletion; otherwise, false.  
