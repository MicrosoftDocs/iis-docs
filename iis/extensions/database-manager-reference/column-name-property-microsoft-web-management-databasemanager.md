...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.web.management.databasemanager.column.name(v=VS.90)
ms:contentKeyID: 20476652
ms.date: 05/02/2012
mtps_version: v=VS.90
f1_keywords:
- Microsoft.Web.Management.DatabaseManager.Column.Name
- Microsoft.Web.Management.DatabaseManager.Column.get_Name
- Microsoft.Web.Management.DatabaseManager.Column.set_Name
dev_langs:
- csharp
- jscript
- vb
...
The value of the database column's Name property may be different than the [OriginalName](column-originalname-property-microsoft-web-management-databasemanager.md) property, which may indicate that the column has been renamed.
