...
ms:contentKeyID: 20476605
ms.date: 05/02/2012
mtps_version: v=VS.90
f1_keywords:
- Microsoft.Web.Management.DatabaseManager.Column.OriginalName
...
Gets or sets a value that specifies the original name of the database column.
...
The value of the database column's OriginalName property may be different than the Name property, which may indicate that the column has been renamed.
