...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.web.management.databasemanager.column.precision(v=VS.90)
ms:contentKeyID: 20476480
ms.date: 05/02/2012
mtps_version: v=VS.90
f1_keywords:
- Microsoft.Web.Management.DatabaseManager.Column.Precision
- Microsoft.Web.Management.DatabaseManager.Column.get_Precision
...
Gets or sets a value that specifies the numeric precision of the database column.
...
Numeric precision refers to the number of base-10 digits that the column can store.
