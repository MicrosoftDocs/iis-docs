...
f1_keywords:
- Microsoft.Web.Management.DatabaseManager.Column.Scale
...
Gets or sets a value that specifies the numeric scale of the database column.
...
The numeric scale for a database column refers to the number of digits that are allowed to the right of the decimal place.
