...
description: Describes the ForeignKey.Name property and provides the property's namespace, assembly, syntax, property value, examples, and permissions.
...
ms:contentKeyID: 20476654
ms.date: 05/02/2012
mtps_version: v=VS.90
f1_keywords:
- Microsoft.Web.Management.DatabaseManager.ForeignKey.Name
- Microsoft.Web.Management.DatabaseManager.ForeignKey.get_Name
- Microsoft.Web.Management.DatabaseManager.ForeignKey.set_Name
dev_langs:
- csharp
- jscript
- vb
...
# ForeignKey.Name Property

Gets or sets a value that specifies the name of the foreign key.
