...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.web.management.databasemanager.foreignkey.originalname(v=VS.90)
ms:contentKeyID: 20476658
ms.date: 05/02/2012
mtps_version: v=VS.90
f1_keywords:
- Microsoft.Web.Management.DatabaseManager.ForeignKey.OriginalName
- Microsoft.Web.Management.DatabaseManager.ForeignKey.get_OriginalName
- Microsoft.Web.Management.DatabaseManager.ForeignKey.set_OriginalName
dev_langs:
- CSharp
- JScript
- VB
...
# ForeignKey.OriginalName Property

Gets or sets a value that specifies the original name of the foreign key.
...
The original name of the foreign key.  

## Remarks

When a foreign key has been renamed, the Name and OriginalName properties will not match.
