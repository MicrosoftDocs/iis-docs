...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.web.management.databasemanager.foreignkey.pktableschema(v=VS.90)
ms:contentKeyID: 20476765
ms.date: 05/02/2012
mtps_version: v=VS.90
f1_keywords:
- Microsoft.Web.Management.DatabaseManager.ForeignKey.PKTableSchema
- Microsoft.Web.Management.DatabaseManager.ForeignKey.get_PKTableSchema
- Microsoft.Web.Management.DatabaseManager.ForeignKey.set_PKTableSchema
dev_langs:
- csharp
- jscript
- vb
...
# ForeignKey.PKTableSchema Property

Gets or sets the schema table name of the primary key.
...
```vb
'Declaration
Public Property PKTableSchema As String
'Usage
Dim instance As ForeignKey
Dim value As String

value = instance.PKTableSchema

instance.PKTableSchema = value
```
...
```jscript
function get PKTableSchema () : String
function set PKTableSchema (value : String)
```

### Property Value

Type: [System.String](https://msdn.microsoft.com/library/s1wwdcbf)  
The schema table name of the primary key.  
