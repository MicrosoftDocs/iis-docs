...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.web.management.databasemanager.index.name(v=VS.90)
ms:contentKeyID: 20476660
ms.date: 05/02/2012
mtps_version: v=VS.90
f1_keywords:
- Microsoft.Web.Management.DatabaseManager.Index.Name
- Microsoft.Web.Management.DatabaseManager.Index.get_Name
- Microsoft.Web.Management.DatabaseManager.Index.set_Name
dev_langs:
- csharp
- jscript
- vb
...
Gets or sets the name for the index.
