...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.web.management.databasemanager.indexcolumn.descending(v=VS.90)
ms:contentKeyID: 20476633
ms.date: 05/02/2012
mtps_version: v=VS.90
f1_keywords:
- Microsoft.Web.Management.DatabaseManager.IndexColumn.Descending
...
Gets or sets a value that indicates whether the index column is a descending index.
...
true if the index column is a descending index; otherwise, false.  
