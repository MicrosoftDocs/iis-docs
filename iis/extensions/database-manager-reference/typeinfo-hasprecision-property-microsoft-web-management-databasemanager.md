...
description: This article contains information about syntax and permissions for the TypeInfo.HasPrecision property.
TOCTitle: HasPrecision Property
ms:assetid: P:Microsoft.Web.Management.DatabaseManager.TypeInfo.HasPrecision
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.web.management.databasemanager.typeinfo.hasprecision(v=VS.90)
ms:contentKeyID: 20476483
ms.date: 05/02/2012
mtps_version: v=VS.90
f1_keywords:
- Microsoft.Web.Management.DatabaseManager.TypeInfo.HasPrecision
- Microsoft.Web.Management.DatabaseManager.TypeInfo.get_HasPrecision
...
Gets or sets a value that indicates whether the data type supports precision.
...
```vb
'Declaration
Public Property HasPrecision As Boolean
'Usage
Dim instance As TypeInfo
Dim value As Boolean

value = instance.HasPrecision

instance.HasPrecision = value
```
...
```jscript
function get HasPrecision () : boolean
function set HasPrecision (value : boolean)
```

### Property Value

Type: [System.Boolean](https://msdn.microsoft.com/library/a28wyd50)  
true if the data type supports precision; otherwise, false.  
