...
ms:contentKeyID: 20476459
ms.date: 05/02/2012
mtps_version: v=VS.90
f1_keywords:
- Microsoft.Web.Management.DatabaseManager.TypeInfo.MaximumPrecision
...
Gets or sets the maximum precision for the data type.
...
value = instance.MaximumPrecision
...
Maximum precision refers to the maximum number of base-10 digits that the data type can store.
