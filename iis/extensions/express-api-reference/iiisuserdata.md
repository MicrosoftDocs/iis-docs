---
title: "IIISUserData"
description: Details the syntax for the IIISUserData which allows per-user IIS Express directories to be queried and created for IIISVersion objects that describe IIS Express.
ms.date: "10/07/2016"
