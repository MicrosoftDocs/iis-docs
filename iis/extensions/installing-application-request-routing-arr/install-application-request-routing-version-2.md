...
2. Select **Application Pools**.  
    ...
    [![Screenshot shows the I I S Manager navigation view with a Application Pools selected.](install-application-request-routing-version-2/_static/image3.jpg)](install-application-request-routing-version-2/_static/image2.jpg)
...
2. Select **Application Pools**.  
    ...
    [![Screenshot shows the navigation view with a Application Pools selected.](install-application-request-routing-version-2/_static/image7.jpg)](install-application-request-routing-version-2/_static/image6.jpg)
