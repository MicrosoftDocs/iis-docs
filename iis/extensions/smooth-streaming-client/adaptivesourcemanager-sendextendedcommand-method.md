...
description: This page details the syntax for the AdaptiveSourceManager.SendExtendedCommand method. It applies to Windows Store apps only. Reserved for future use.
