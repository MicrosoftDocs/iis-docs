...
description: Describes the ClipContext methods and provides a table that outlines the name and description for various method types.
TOCTitle: ClipContext Methods
ms:assetid: Methods.T:Microsoft.Web.Media.SmoothStreaming.ClipContext
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.web.media.smoothstreaming.clipcontext_methods(v=VS.95)
ms:contentKeyID: 46307596
ms.date: 05/31/2012
