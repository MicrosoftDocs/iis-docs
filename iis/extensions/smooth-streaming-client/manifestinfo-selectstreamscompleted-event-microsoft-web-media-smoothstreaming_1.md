...
description: "The ManifestInfo.SelectStreamsCompleted event is activated when a SelectStreamsAsync call has completed in any of the segments contained in Segments."
