...
description: "This article provides guidelines on multiple camera angles for IIS Smooth Streaming, including code examples on configuring mulitple camera angles in manifest, parsing the manifest and sorting tracks, and changing camera angles."
