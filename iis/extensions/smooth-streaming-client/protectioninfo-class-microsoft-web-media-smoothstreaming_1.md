...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.web.media.smoothstreaming.protectioninfo(v=VS.95)
ms:contentKeyID: 46307959
ms.date: 05/31/2012
...
||Name|Description|
|--- |--- |--- |
|![Public method](images/Ff728153.pubmethod(en-us,VS.90).gif "Public method")![Supported by Windows Phone](images/Ff728255.slMobile(VS.95).gif "Supported by Windows Phone")|[ProtectionInfo](protectioninfo-constructor-microsoft-web-media-smoothstreaming_1.md)|Initializes a new instance of the ProtectionInfo class.|
