...
description: Details the syntax for the SmoothStreamingAsyncResult.CompletedSynchronously property and indicates if the operation completed on the same thread.
