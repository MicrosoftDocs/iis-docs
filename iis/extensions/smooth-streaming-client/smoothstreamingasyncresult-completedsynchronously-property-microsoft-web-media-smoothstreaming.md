...
description: Details the syntax for the SmoothStreamingAsyncResult.CompletedSynchronously property which indicates if the operation completed on the same thread.
