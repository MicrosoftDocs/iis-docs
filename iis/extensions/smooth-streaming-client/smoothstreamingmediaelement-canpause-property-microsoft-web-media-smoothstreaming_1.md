...
description: Details the syntax for the SmoothStreamingMediaElement.CanPause property gets or sets a value that specifies whether the stream can be paused.
