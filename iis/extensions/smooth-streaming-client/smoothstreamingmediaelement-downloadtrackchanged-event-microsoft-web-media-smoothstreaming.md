...
description: "The SmoothStreamingMediaElement.DownloadTrackChanged event occurs when the track selected for download differs from the previously selected track."
