...
description: Describes the PostInterval field and provides the field's syntax, version information, and permissions.
TOCTitle: PostInterval Field
ms:assetid: F:Microsoft.Web.Media.Diagnostics.Tracing.PostInterval
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.web.media.diagnostics.tracing.postinterval(v=VS.90)
