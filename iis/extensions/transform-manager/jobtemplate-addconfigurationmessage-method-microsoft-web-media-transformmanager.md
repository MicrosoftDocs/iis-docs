...
description: Details the syntax for the AddConfigurationMessage method. This adds a message to the IIS Transform Manager configuration.
...
ms:contentKeyID: 35520852
ms.date: 06/14/2012
mtps_version: v=VS.90
f1_keywords:
- Microsoft.Web.Media.TransformManager.JobTemplate.AddConfigurationMessage
dev_langs:
- csharp
- jscript
- vb
