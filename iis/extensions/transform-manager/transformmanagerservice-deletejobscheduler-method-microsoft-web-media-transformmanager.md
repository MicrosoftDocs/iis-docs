...
description: Describes the DeleteJobScheduler method and provides the method's namespace, assembly, syntax, parameters, what the method implements, and exceptions.
