...
| [IPlaylistEntryInfoCollection Interface](iplaylistentryinfocollection-interface.md) |                                  Allows a custom provider to traverse a list of Playlist entries in the form of [IPlaylistEntryInfo Interface](iplaylistentryinfo-interface.md)                                  |
