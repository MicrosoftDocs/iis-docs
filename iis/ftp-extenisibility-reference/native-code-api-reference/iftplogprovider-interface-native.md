...
|-|-|  
|Name|Definition|  
|[IFtpLogProvider::Log Method](../../ftp-extenisibility-reference\native-code-api\iftplogprovider-log-method.md)|Performs logging activity for the `IFtpLogProvider` interface.|  
