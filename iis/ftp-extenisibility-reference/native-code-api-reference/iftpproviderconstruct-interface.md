...
|-|-|  
|Name|Definition|  
|[IFtpProviderConstruct::Construct Method](../../ftp-extenisibility-reference\native-code-api\iftpproviderconstruct-construct-method.md)|Retrieves an array of key/value pairs from an FTP provider's configuration settings in the IIS ApplicationHost.config file.|  
