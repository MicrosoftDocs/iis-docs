...
For more detailed information on how to work with FREB, see [Troubleshooting Failed Requests Using Tracing in IIS 7](../../troubleshoot/using-failed-request-tracing/troubleshooting-failed-requests-using-tracing-in-iis.md).
