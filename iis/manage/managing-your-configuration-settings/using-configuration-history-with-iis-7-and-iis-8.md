...
1. Click **Start**, click **Run**, and in the **Open:** dialog box, type notepad and **Click** OK.  
    ![Screenshot showing the I I S Configuration History Run menu. The menu entry notepad is highlighted.](using-configuration-history-with-iis-7-and-iis-8/_static/image1.png)  
...
2. **Click** File, then **Open**, and in the **File name:** dialog box, type `%windir%\system32\inetsrv\config\applicationHost.config`. **Click** Open.  
    ![Screenshot showing the I I S Configuration Open menu. The File name dialog box entry is highlighted.](using-configuration-history-with-iis-7-and-iis-8/_static/image5.png)  
...
2. Click **File**, then **Open**, and in the **File name:** dialog box, type `%windir%\system32\inetsrv\config\schema\iis\_schema.xml`.  
    ![Screenshot showing the I I S schema file in Notepad, containing the configHistory default settings.](using-configuration-history-with-iis-7-and-iis-8/_static/image9.png)  
...
3. On Windows Server® 2008, you see the following:  
     ![Screenshot showing the I I S schema file on  Windows Server 2008. The default configHistory schema is highlighted.](using-configuration-history-with-iis-7-and-iis-8/_static/image2.jpg)  
...
1. Click **Start**, **Run**, and type Inetmgr and Click **OK**.  
    ![Screenshot showing adding a server name in the I I S Manager Open menu.](using-configuration-history-with-iis-7-and-iis-8/_static/image12.png)  
...
2. Right-click the server, and choose Add Web Site.  
     ![Screenshot showing the I I S Manager navigation tree window and the Add Web Site menu option. The I I S 7 Server is highlighted.](using-configuration-history-with-iis-7-and-iis-8/_static/image14.png)  
     **Figure 6: Add Web Site**
3. In the **Add Web Site** wizard, enter information to create a new Website. For example:  
     ![Screenshot showing the Add Web Site wizard window. The window contains sample information to create a new website.](using-configuration-history-with-iis-7-and-iis-8/_static/image16.png)  
     **Figure 7: Add Web Site Wizard**
4. Click **OK**.
5. You now see the new Website created in your IIS Manager, as in the following:  
     ![Screenshot showing a new website homepage, in the I I S Manager. The new website, MyWebSite Home, is highlighted in the navigation tree.](using-configuration-history-with-iis-7-and-iis-8/_static/image18.png)  
...
![Screeshot showing the Services window, with Application Host Helper Service highlighted.](using-configuration-history-with-iis-7-and-iis-8/_static/image24.png)  
