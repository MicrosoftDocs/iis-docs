...
1. Download the executable from http://www.erezbenari.com/apps/IISLogCleaner.exe and save the executable in a folder of your choice on the server (there is no installer).
