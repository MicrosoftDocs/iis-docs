...
1. Download the executable by executing http://www.erezbenari.com/apps/includes/apps/iislogcleaner.html and saving the executable in a folder of your choice on the server (there is no installer).
