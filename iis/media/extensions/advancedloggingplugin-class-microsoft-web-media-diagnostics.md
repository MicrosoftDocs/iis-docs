...
``` vb
'Declaration
PublicClassAdvancedLoggingPlugin
'Usage
DiminstanceAsAdvancedLoggingPlugin
```
...
``` c++
publicref classAdvancedLoggingPlugin
```

``` jscript
publicclass AdvancedLoggingPlugin
```
...
<td>Gets or sets the [SmoothStreamingMediaElement] that this plug-in will service.</td>
</tr>
<tr class="even">
<td><img src="images/Dd565996.pubproperty(en-us,VS.90).gif" title="Public property" alt="Public property" /><img src="images/Ff728271.slMobile(en-us,VS.90).gif" title="Supported by Silverlight for Windows Phone" alt="Supported by Silverlight for Windows Phone" /></td>
