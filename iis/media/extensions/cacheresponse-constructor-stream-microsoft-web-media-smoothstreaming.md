...
Initializes a new instance of the [CacheResponse](cacheresponse-class-microsoft-web-media-smoothstreaming_1.md) class from a [Stream](https://msdn.microsoft.com/en-us/library/8f86tw9e\(v=vs.90\)) object.
...
'Usage
DimstreamAsStreamDiminstanceAs NewCacheResponse(stream)
```
