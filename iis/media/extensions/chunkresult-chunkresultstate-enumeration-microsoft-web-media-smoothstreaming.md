...
``` vb
'Declaration
PublicEnumerationChunkResultState
'Usage
DiminstanceAsChunkResult.ChunkResultState
```

``` csharp
publicenumChunkResultState
```

``` c++
publicenum classChunkResultState
```

``` jscript
publicenum ChunkResultState
```
