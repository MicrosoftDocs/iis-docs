...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/Ff728270(v=VS.90)
...
``` vb
'Declaration
PublicFunctionIsFullAsBoolean
'Usage
DiminstanceAsCircularListDimreturnValueAsBooleanreturnValue = instance.IsFull()
```
