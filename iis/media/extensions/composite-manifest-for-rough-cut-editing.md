...
> [!NOTE]
> <P>The examples in this topic extend features that are demonstrated in the topic <A href="silverlight-applications.md">Silverlight Applications</A>. For more information, see all topics under <A href="microsoft-smooth-streaming-client-2-0.md">Microsoft Smooth Streaming Client 2.0</A>.</P>
