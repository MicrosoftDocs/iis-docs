...
'Usage
DiminstanceAsConfigurationBaseDimvalueAsLogLevelvalue = instance.LogLevel
...
``` fsharp
[<DataMemberAttribute>]
memberLogLevel : LogLevelwithget, set
```

``` jscript
function getLogLevel () : LogLevelfunction setLogLevel (value : LogLevel)
```
