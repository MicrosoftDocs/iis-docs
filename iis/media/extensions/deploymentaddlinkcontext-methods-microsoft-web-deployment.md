---
title: DeploymentAddLinkContext Methods (Microsoft.Web.Deployment)
TOCTitle: DeploymentAddLinkContext Methods
ms:assetid: Methods.T:Microsoft.Web.Deployment.DeploymentAddLinkContext
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.web.deployment.deploymentaddlinkcontext_methods(v=VS.90)
ms:contentKeyID: 20208846
ms.date: 05/02/2012
mtps_version: v=VS.90
---

# DeploymentAddLinkContext Methods

The [DeploymentAddLinkContext](deploymentaddlinkcontext-class-microsoft-web-deployment.md) type exposes the following members.
