---
title: DeploymentCanceledException Class (Microsoft.Web.Deployment)
TOCTitle: DeploymentCanceledException Class
ms:assetid: T:Microsoft.Web.Deployment.DeploymentCanceledException
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.web.deployment.deploymentcanceledexception(v=VS.90)
ms:contentKeyID: 20209308
ms.date: 05/02/2012
...
PublicClassDeploymentCanceledException _
    InheritsException
'Usage
DiminstanceAsDeploymentCanceledException
```

``` csharp
[SerializableAttribute]
publicclassDeploymentCanceledException : Exception
```

``` c++
[SerializableAttribute]
publicref classDeploymentCanceledException : publicException
```

``` jscript
publicclass DeploymentCanceledException extendsException
```
...
<td>Creates an instance of a DeploymentCanceledException object with default values.</td>
</tr>
<tr class="even">
<td><img src="images/Dd565996.pubmethod(en-us,VS.90).gif" title="Public method" alt="Public method" /></td>
...
<td>Creates an instance of a DeploymentCanceledException object with the specified message.</td>
</tr>
<tr class="odd">
...
<td>Creates an instance of a DeploymentCanceledException object from serialization information.</td>
</tr>
<tr class="even">
<td><img src="images/Dd565996.pubmethod(en-us,VS.90).gif" title="Public method" alt="Public method" /></td>
...
<td>Creates an instance of a DeploymentCanceledException object with the specified message and inner exception.</td>
</tr>
</tbody>
</table>
