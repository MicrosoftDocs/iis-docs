---
title: DeploymentCanceledException Methods (Microsoft.Web.Deployment)
TOCTitle: DeploymentCanceledException Methods
ms:assetid: Methods.T:Microsoft.Web.Deployment.DeploymentCanceledException
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.web.deployment.deploymentcanceledexception_methods(v=VS.90)
ms:contentKeyID: 20209081
ms.date: 05/02/2012
mtps_version: v=VS.90
---

# DeploymentCanceledException Methods

The [DeploymentCanceledException](deploymentcanceledexception-class-microsoft-web-deployment.md) type exposes the following members.
