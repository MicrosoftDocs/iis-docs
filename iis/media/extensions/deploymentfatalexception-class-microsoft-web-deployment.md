---
title: DeploymentFatalException Class (Microsoft.Web.Deployment)
TOCTitle: DeploymentFatalException Class
ms:assetid: T:Microsoft.Web.Deployment.DeploymentFatalException
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.web.deployment.deploymentfatalexception(v=VS.90)
ms:contentKeyID: 20208989
ms.date: 05/02/2012
...
    Microsoft.Web.Deployment..::..DeploymentFatalException  
      [Microsoft.Web.Deployment. . :: . .DeploymentEncryptionException](deploymentencryptionexception-class-microsoft-web-deployment.md)  
...
PublicClassDeploymentFatalException _
    InheritsException
'Usage
DiminstanceAsDeploymentFatalException
```

``` csharp
[SerializableAttribute]
publicclassDeploymentFatalException : Exception
```

``` c++
[SerializableAttribute]
publicref classDeploymentFatalException : publicException
```

``` jscript
publicclass DeploymentFatalException extendsException
```
...
<td>Creates an instance of a DeploymentFatalException object with default values.</td>
</tr>
<tr class="even">
<td><img src="images/Dd565996.pubmethod(en-us,VS.90).gif" title="Public method" alt="Public method" /></td>
<td><a href="deploymentfatalexception-constructor-string-microsoft-web-deployment.md">DeploymentFatalException(String)</a></td>
<td>Creates an instance of a DeploymentFatalException object by using the specified message.</td>
</tr>
<tr class="odd">
...
<td>Creates an instance of a DeploymentFatalException object by using serialization data.</td>
</tr>
<tr class="even">
<td><img src="images/Dd565996.pubmethod(en-us,VS.90).gif" title="Public method" alt="Public method" /></td>
...
<td>Creates an instance of a DeploymentFatalException object by using the message and inner exception specified.</td>
</tr>
<tr class="odd">
<td><img src="images/Dd565996.pubmethod(en-us,VS.90).gif" title="Public method" alt="Public method" /></td>
...
<td>Creates an instance of a DeploymentFatalException object with the specified message and array of parameters.</td>
</tr>
<tr class="even">
<td><img src="images/Dd565996.pubmethod(en-us,VS.90).gif" title="Public method" alt="Public method" /></td>
...
<td>Creates an instance of a DeploymentFatalException object with the specified message, inner exception and array of parameters.</td>
</tr>
</tbody>
</table>
