---
title: DeploymentFatalException Properties (Microsoft.Web.Deployment)
TOCTitle: DeploymentFatalException Properties
ms:assetid: Properties.T:Microsoft.Web.Deployment.DeploymentFatalException
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.web.deployment.deploymentfatalexception_properties(v=VS.90)
ms:contentKeyID: 20208880
ms.date: 05/02/2012
mtps_version: v=VS.90
---

# DeploymentFatalException Properties

The [DeploymentFatalException](deploymentfatalexception-class-microsoft-web-deployment.md) type exposes the following members.
