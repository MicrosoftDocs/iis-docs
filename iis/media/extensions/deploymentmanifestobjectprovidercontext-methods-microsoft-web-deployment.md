---
title: DeploymentManifestObjectProviderContext Methods (Microsoft.Web.Deployment)
TOCTitle: DeploymentManifestObjectProviderContext Methods
ms:assetid: Methods.T:Microsoft.Web.Deployment.DeploymentManifestObjectProviderContext
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.web.deployment.deploymentmanifestobjectprovidercontext_methods(v=VS.90)
ms:contentKeyID: 20209178
ms.date: 05/02/2012
mtps_version: v=VS.90
---

# DeploymentManifestObjectProviderContext Methods

The [DeploymentManifestObjectProviderContext](deploymentmanifestobjectprovidercontext-class-microsoft-web-deployment.md) type exposes the following members.
