---
title: DeploymentMethodAttribute Class (Microsoft.Web.Deployment)
TOCTitle: DeploymentMethodAttribute Class
ms:assetid: T:Microsoft.Web.Deployment.DeploymentMethodAttribute
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.web.deployment.deploymentmethodattribute(v=VS.90)
ms:contentKeyID: 22753870
ms.date: 05/02/2012
mtps_version: v=VS.90
f1_keywords:
- Microsoft.Web.Deployment.DeploymentMethodAttribute
dev_langs:
- CSharp
- JScript
- VB
...
PublicNotInheritableClassDeploymentMethodAttribute _
    InheritsAttribute
'Usage
DiminstanceAsDeploymentMethodAttribute
```

``` csharp
[AttributeUsageAttribute(AttributeTargets.Class, AllowMultiple = false, Inherited = false)]
publicsealedclassDeploymentMethodAttribute : Attribute
```

``` c++
[AttributeUsageAttribute(AttributeTargets::Class, AllowMultiple = false, Inherited = false)]
publicref classDeploymentMethodAttributesealed : publicAttribute
```

``` jscript
publicfinalclass DeploymentMethodAttribute extendsAttribute
```

The DeploymentMethodAttribute type exposes the following members.
...
<td><a href="deploymentmethodattribute-constructor-microsoft-web-deployment.md">DeploymentMethodAttribute</a></td>
<td>Initializes a new instance of a DeploymentMethodAttribute class.</td>
</tr>
</tbody>
</table>
