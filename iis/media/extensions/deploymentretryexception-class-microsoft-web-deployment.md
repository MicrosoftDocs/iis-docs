---
title: DeploymentRetryException Class (Microsoft.Web.Deployment)
TOCTitle: DeploymentRetryException Class
ms:assetid: T:Microsoft.Web.Deployment.DeploymentRetryException
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.web.deployment.deploymentretryexception(v=VS.90)
ms:contentKeyID: 20209213
ms.date: 05/02/2012
...
PublicClassDeploymentRetryException _
    InheritsException
'Usage
DiminstanceAsDeploymentRetryException
```

``` csharp
[SerializableAttribute]
publicclassDeploymentRetryException : Exception
```

``` c++
[SerializableAttribute]
publicref classDeploymentRetryException : publicException
```

``` jscript
publicclass DeploymentRetryException extendsException
```
...
<td>Creates a default instance of a DeploymentRetryException object.</td>
</tr>
<tr class="even">
<td><img src="images/Dd565996.pubmethod(en-us,VS.90).gif" title="Public method" alt="Public method" /></td>
<td><a href="deploymentretryexception-constructor-string-microsoft-web-deployment.md">DeploymentRetryException(String)</a></td>
<td>Creates an instance of a DeploymentRetryException object with the specified message.</td>
</tr>
<tr class="odd">
...
<td>Creates an instance of a DeploymentRetryException object from serialized data.</td>
</tr>
<tr class="even">
<td><img src="images/Dd565996.pubmethod(en-us,VS.90).gif" title="Public method" alt="Public method" /></td>
...
<td>Creates an instance of a DeploymentRetryException object with the specified message and a reference to the inner exception that is the cause of this exception.</td>
</tr>
<tr class="odd">
<td><img src="images/Dd565996.pubmethod(en-us,VS.90).gif" title="Public method" alt="Public method" /></td>
...
<td>Creates an instance of a DeploymentRetryException object with the specified inner exception, message and an array of parameters related to the exception</td>
</tr>
</tbody>
</table>
