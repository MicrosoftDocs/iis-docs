---
title: DeploymentRetryException Properties (Microsoft.Web.Deployment)
TOCTitle: DeploymentRetryException Properties
ms:assetid: Properties.T:Microsoft.Web.Deployment.DeploymentRetryException
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.web.deployment.deploymentretryexception_properties(v=VS.90)
ms:contentKeyID: 20208763
ms.date: 05/02/2012
mtps_version: v=VS.90
---

# DeploymentRetryException Properties

The [DeploymentRetryException](deploymentretryexception-class-microsoft-web-deployment.md) type exposes the following members.
