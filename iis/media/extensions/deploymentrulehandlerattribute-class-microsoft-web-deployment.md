---
title: DeploymentRuleHandlerAttribute Class (Microsoft.Web.Deployment)
TOCTitle: DeploymentRuleHandlerAttribute Class
ms:assetid: T:Microsoft.Web.Deployment.DeploymentRuleHandlerAttribute
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.web.deployment.deploymentrulehandlerattribute(v=VS.90)
ms:contentKeyID: 22754073
ms.date: 05/02/2012
mtps_version: v=VS.90
f1_keywords:
- Microsoft.Web.Deployment.DeploymentRuleHandlerAttribute
dev_langs:
- CSharp
- JScript
- VB
...
PublicNotInheritableClassDeploymentRuleHandlerAttribute _
    InheritsAttribute
'Usage
DiminstanceAsDeploymentRuleHandlerAttribute
```

``` csharp
[AttributeUsageAttribute(AttributeTargets.Class, AllowMultiple = false, Inherited = false)]
publicsealedclassDeploymentRuleHandlerAttribute : Attribute
```

``` c++
[AttributeUsageAttribute(AttributeTargets::Class, AllowMultiple = false, Inherited = false)]
publicref classDeploymentRuleHandlerAttributesealed : publicAttribute
```

``` jscript
publicfinalclass DeploymentRuleHandlerAttribute extendsAttribute
```

The DeploymentRuleHandlerAttribute type exposes the following members.
...
<td><a href="deploymentrulehandlerattribute-constructor-microsoft-web-deployment.md">DeploymentRuleHandlerAttribute</a></td>
<td>Initializes a new instance of a DeploymentRuleHandlerAttribute class.</td>
</tr>
</tbody>
</table>
