---
title: DeploymentSkipRule Class (Microsoft.Web.Deployment)
TOCTitle: DeploymentSkipRule Class
ms:assetid: T:Microsoft.Web.Deployment.DeploymentSkipRule
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.web.deployment.deploymentskiprule(v=VS.90)
ms:contentKeyID: 22754052
ms.date: 05/02/2012
...
``` vb
'Declaration
PublicClassDeploymentSkipRule _
    InheritsDeploymentRule
'Usage
DiminstanceAsDeploymentSkipRule
```

``` csharp
publicclassDeploymentSkipRule : DeploymentRule
```

``` c++
publicref classDeploymentSkipRule : publicDeploymentRule
```

``` jscript
publicclass DeploymentSkipRule extendsDeploymentRule
```

The DeploymentSkipRule type exposes the following members.
...
<td><a href="deploymentskiprule-constructor-microsoft-web-deployment.md">DeploymentSkipRule</a></td>
<td></td>
</tr>
</tbody>
</table>
