---
title: DeploymentWebServerConfigurationSystemInfo Class (Microsoft.Web.Deployment)
TOCTitle: DeploymentWebServerConfigurationSystemInfo Class
ms:assetid: T:Microsoft.Web.Deployment.DeploymentWebServerConfigurationSystemInfo
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.web.deployment.deploymentwebserverconfigurationsysteminfo(v=VS.90)
ms:contentKeyID: 22753878
ms.date: 05/02/2012
...
``` vb
'Declaration
PublicClassDeploymentWebServerConfigurationSystemInfo
'Usage
DiminstanceAsDeploymentWebServerConfigurationSystemInfo
```
...
``` c++
publicref classDeploymentWebServerConfigurationSystemInfo
```

``` jscript
publicclass DeploymentWebServerConfigurationSystemInfo
```
...
<td><a href="deploymentwebserverconfigurationsysteminfo-constructor-microsoft-web-deployment.md">DeploymentWebServerConfigurationSystemInfo</a></td>
<td>Initializes a new instance of the DeploymentWebServerConfigurationSystemInfo class.</td>
</tr>
</tbody>
</table>
