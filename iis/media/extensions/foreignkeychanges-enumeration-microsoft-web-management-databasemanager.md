...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.web.management.databasemanager.foreignkeychanges(v=VS.90)
ms:contentKeyID: 20476411
ms.date: 05/02/2012
mtps_version: v=VS.90
f1_keywords:
- Microsoft.Web.Management.DatabaseManager.ForeignKeyChanges.IsMarkedForDelete
- Microsoft.Web.Management.DatabaseManager.ForeignKeyChanges
...
<td></td>
<td>None</td>
<td>The foreign key has no pending changes.</td>
</tr>
<tr class="even">
<td></td>
<td>IsNew</td>
<td>The foreign key is new.</td>
</tr>
<tr class="odd">
<td></td>
<td>IsMarkedForDelete</td>
<td>The foreign key is marked for deletion.</td>
</tr>
</tbody>
</table>
...
This enumeration is used with the [GetChanges](foreignkey-getchanges-method-microsoft-web-management-databasemanager.md) method.
