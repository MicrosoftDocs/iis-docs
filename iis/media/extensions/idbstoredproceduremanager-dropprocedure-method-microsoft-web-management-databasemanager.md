...
> [!NOTE]
> <P>See the <A href="http://msdn.microsoft.com/en-us/library/ms174969.aspx">DROP PROCEDURE (Transact-SQL)</A> topic for more information about the DROP PROCEDURE SQL statement.</P>
