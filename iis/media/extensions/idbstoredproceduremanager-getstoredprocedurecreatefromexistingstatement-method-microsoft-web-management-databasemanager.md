...
> [!NOTE]
> <P>See the <A href="http://msdn.microsoft.com/en-us/library/ms187926.aspx">CREATE PROCEDURE (Transact-SQL)</A> topic for more information about the CREATE PROCEDURE SQL statement.</P>
