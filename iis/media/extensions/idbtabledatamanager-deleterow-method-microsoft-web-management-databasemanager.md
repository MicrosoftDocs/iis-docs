...
> [!NOTE]
> <P>See the <A href="http://msdn.microsoft.com/en-us/library/ms189835.aspx">DELETE (Transact-SQL)</A> topic for more information about the DELETE SQL statement.</P>
