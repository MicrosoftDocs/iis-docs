...
> [!NOTE]
> <P>See the <A href="http://msdn.microsoft.com/en-us/library/ms177523.aspx">UPDATE (Transact-SQL)</A> topic for more information about the UPDATE SQL statement.</P>
