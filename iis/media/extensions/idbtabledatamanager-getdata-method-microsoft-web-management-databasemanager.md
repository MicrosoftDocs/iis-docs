...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.web.management.databasemanager.idbtabledatamanager.getdata(v=VS.90)
...
> [!NOTE]
> <P>See the <A href="http://msdn.microsoft.com/en-us/library/ms176104.aspx">SELECT Clause (Transact-SQL)</A> topic for more information about the SELECT SQL statement.</P>
