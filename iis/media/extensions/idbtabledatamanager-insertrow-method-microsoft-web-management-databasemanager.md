...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.web.management.databasemanager.idbtabledatamanager.insertrow(v=VS.90)
...
> [!NOTE]
> <P>See the <A href="http://msdn.microsoft.com/en-us/library/ms174335.aspx">INSERT (Transact-SQL)</A> topic for more information about the INSERT SQL statement.</P>
