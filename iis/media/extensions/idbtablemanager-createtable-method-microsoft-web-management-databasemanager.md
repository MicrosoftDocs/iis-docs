...
> [!NOTE]
> <P>See the <A href="http://msdn.microsoft.com/en-us/library/ms174979.aspx">CREATE TABLE (Transact-SQL)</A> topic for more information about the CREATE TABLE SQL statement.</P>
