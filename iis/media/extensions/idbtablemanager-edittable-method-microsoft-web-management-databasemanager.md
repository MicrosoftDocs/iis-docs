...
> [!NOTE]
> <P>See the <A href="http://msdn.microsoft.com/en-us/library/ms190273.aspx">ALTER TABLE (Transact-SQL)</A> topic for more information about the ALTER TABLE SQL statement.</P>
