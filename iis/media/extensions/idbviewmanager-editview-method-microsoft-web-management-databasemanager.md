...
> [!NOTE]
> <P>See the <A href="http://msdn.microsoft.com/en-us/library/ms173846.aspx">ALTER VIEW (Transact-SQL)</A> topic for more information about the ALTER VIEW SQL statement.</P>
