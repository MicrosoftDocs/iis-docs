...
FunctionGetRunningJobsAsCollection(OfJobDetails)
'Usage
DiminstanceAsIMonitoringServiceDimreturnValueAsCollection(OfJobDetails)
...
``` jscript
functionGetRunningJobs() : Collection<JobDetails>
```
