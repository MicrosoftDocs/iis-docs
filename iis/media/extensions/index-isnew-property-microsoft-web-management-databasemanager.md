...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.web.management.databasemanager.index.isnew(v=VS.90)
ms:contentKeyID: 20476653
ms.date: 05/02/2012
mtps_version: v=VS.90
f1_keywords:
- Microsoft.Web.Management.DatabaseManager.Index.IsNew
- Microsoft.Web.Management.DatabaseManager.Index.get_IsNew
- Microsoft.Web.Management.DatabaseManager.Index.set_IsNew
dev_langs:
- CSharp
- JScript
- VB
...
# Index.IsNew Property

Gets or sets a value that indicates whether the index is new.
...
true if the index is new; otherwise, false.  
