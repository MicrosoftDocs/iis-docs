...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.web.management.databasemanager.indexchanges(v=VS.90)
ms:contentKeyID: 20476604
ms.date: 05/02/2012
mtps_version: v=VS.90
f1_keywords:
- Microsoft.Web.Management.DatabaseManager.IndexChanges
- Microsoft.Web.Management.DatabaseManager.IndexChanges.IsMarkedForDelete
- Microsoft.Web.Management.DatabaseManager.IndexChanges.None
- Microsoft.Web.Management.DatabaseManager.IndexChanges.IsNew
- Microsoft.Web.Management.DatabaseManager.IndexChanges.Name
dev_langs:
- CSharp
- JScript
- VB
...
Specifies the types of index changes for a database.
...
'Declaration
<FlagsAttribute> _
Public Enumeration IndexChanges
'Usage
Dim instance As IndexChanges
```

``` csharp
[FlagsAttribute]
public enum IndexChanges
```

``` c++
[FlagsAttribute]
public enum class IndexChanges
```
...
<td></td>
<td>None</td>
<td>The index has no changes.</td>
</tr>
<tr class="even">
<td></td>
<td>IsNew</td>
<td>The index is new.</td>
</tr>
<tr class="odd">
<td></td>
<td>IsMarkedForDelete</td>
<td>The index is marked for deletion.</td>
</tr>
<tr class="even">
<td></td>
<td>Name</td>
<td>The name of the index was changed.</td>
</tr>
</tbody>
</table>
...
This enumeration is used with the [GetChanges](index-getchanges-method-microsoft-web-management-databasemanager.md) method.
