...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.web.management.databasemanager.indexcolumn.name(v=VS.90)
ms:contentKeyID: 20476598
ms.date: 05/02/2012
mtps_version: v=VS.90
f1_keywords:
- Microsoft.Web.Management.DatabaseManager.IndexColumn.Name
- Microsoft.Web.Management.DatabaseManager.IndexColumn.get_Name
- Microsoft.Web.Management.DatabaseManager.IndexColumn.set_Name
dev_langs:
- CSharp
- JScript
- VB
