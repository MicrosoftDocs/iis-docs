...
> [!NOTE]
> <P>The examples in this topic extend features demonstrated in other topics in <A href="microsoft-smooth-streaming-client-2-0.md">IIS Smooth Streaming Client 1.5</A>. All the code is available for download in the <A href="http://go.microsoft.com/fwlink/?linkid=182167">IIS Smooth Streaming Sample Application</A>.</P>
