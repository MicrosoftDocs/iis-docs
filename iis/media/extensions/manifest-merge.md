...
> [!NOTE]
> <P>The examples in this topic extend features demonstrated in other topics in <A href="microsoft-smooth-streaming-client-2-0.md">Microsoft Smooth Streaming Client 2.0</A>.</P>
