...
> [!NOTE]
> <P>For information about the SQL syntax that is available for the Statement property, see the <A href="http://msdn.microsoft.com/en-us/library/bb510741.aspx">Transact-SQL Reference</A> topic on the Microsoft MSDN Web site.</P>
