...
> [!NOTE]
> <P>IIS Smooth Streaming Clips scheduled by using <A href="smoothstreamingmediaelement-scheduleclip-method-microsoft-web-media-smoothstreaming_1.md">ScheduleClip</A> methods require manifests that start at the zero timestamp.</P>
