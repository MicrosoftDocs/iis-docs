...
``` vb
'Declaration
PublicPropertySuccessAsBoolean
'Usage
DiminstanceAsSeekCompletedEventArgsDimvalueAsBooleanvalue = instance.Success
...
``` jscript
function getSuccess () : booleanfunction setSuccess (value : boolean)
```
