...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.web.media.smoothstreaming.segmentinfo_methods(v=VS.95)
ms:contentKeyID: 46307598
ms.date: 05/31/2012
...
<td><a href="segmentinfo-restrictstreams-method-microsoft-web-media-smoothstreaming.md">RestrictStreams</a></td>
<td>Restricts decoder initialization to the specified list of available streams.</td>
</tr>
<tr class="odd">
<td><img src="images/Dd565996.pubmethod(en-us,VS.90).gif" title="Public method" alt="Public method" /> <img src="images/Ee532579.slMobile(VS.95).gif" title="Supported by Windows Phone" alt="Supported by Windows Phone" /></td>
