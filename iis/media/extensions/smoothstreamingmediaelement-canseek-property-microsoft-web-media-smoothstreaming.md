...
``` vb
'Declaration
PublicPropertyCanSeekAsBoolean
'Usage
DiminstanceAsSmoothStreamingMediaElementDimvalueAsBooleanvalue = instance.CanSeek

instance.CanSeek = value
```

``` csharp
publicboolCanSeek { get; set; }
```
...
``` jscript
function getCanSeek () : booleanfunction setCanSeek (value : boolean)
```
