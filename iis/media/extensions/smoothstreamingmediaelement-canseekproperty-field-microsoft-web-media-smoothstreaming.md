...
``` vb
'Declaration
PublicSharedReadOnlyCanSeekPropertyAsDependencyProperty
'Usage
DimvalueAsDependencyPropertyvalue = SmoothStreamingMediaElement.CanSeekProperty
```

``` csharp
publicstaticreadonlyDependencyPropertyCanSeekProperty
```

``` c++
public:
staticinitonlyDependencyProperty^ CanSeekProperty
```

``` jscript
publicstaticfinalvarCanSeekProperty : DependencyProperty
```
