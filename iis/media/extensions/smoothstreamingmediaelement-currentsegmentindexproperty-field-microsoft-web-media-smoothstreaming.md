...
``` vb
'Declaration
PublicSharedReadOnlyCurrentSegmentIndexPropertyAsDependencyProperty
'Usage
DimvalueAsDependencyPropertyvalue = SmoothStreamingMediaElement.CurrentSegmentIndexProperty
```

``` csharp
publicstaticreadonlyDependencyPropertyCurrentSegmentIndexProperty
```

``` c++
public:
staticinitonlyDependencyProperty^ CurrentSegmentIndexProperty
```

``` jscript
publicstaticfinalvarCurrentSegmentIndexProperty : DependencyProperty
```
