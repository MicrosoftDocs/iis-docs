...
``` vb
'Declaration
PublicSharedReadOnlyDownloadProgressPropertyAsDependencyProperty
'Usage
DimvalueAsDependencyPropertyvalue = SmoothStreamingMediaElement.DownloadProgressProperty
```

``` csharp
publicstaticreadonlyDependencyPropertyDownloadProgressProperty
```

``` c++
public:
staticinitonlyDependencyProperty^ DownloadProgressProperty
```

``` jscript
publicstaticfinalvarDownloadProgressProperty : DependencyProperty
```
