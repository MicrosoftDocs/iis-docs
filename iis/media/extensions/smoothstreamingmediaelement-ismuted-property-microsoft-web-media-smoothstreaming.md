...
``` vb
'Declaration
PublicPropertyIsMutedAsBoolean
'Usage
DiminstanceAsSmoothStreamingMediaElementDimvalueAsBooleanvalue = instance.IsMuted

instance.IsMuted = value
```

``` csharp
publicboolIsMuted { get; set; }
```
...
``` jscript
function getIsMuted () : booleanfunction setIsMuted (value : boolean)
```
