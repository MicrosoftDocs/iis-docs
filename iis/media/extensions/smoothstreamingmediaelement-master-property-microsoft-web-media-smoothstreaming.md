...
``` vb
'Declaration
PublicPropertyMasterAsSmoothStreamingMediaElement
'Usage
DiminstanceAsSmoothStreamingMediaElementDimvalueAsSmoothStreamingMediaElementvalue = instance.Master

instance.Master = value
```

``` csharp
publicSmoothStreamingMediaElementMaster { get; set; }
```

``` c++
public:
propertySmoothStreamingMediaElement^ Master {
...
``` jscript
function getMaster () : SmoothStreamingMediaElementfunction setMaster (value : SmoothStreamingMediaElement)
```
