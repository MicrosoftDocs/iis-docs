...
``` vb
'Declaration
Public Event MediaEndedAsRoutedEventHandler
'Usage
DiminstanceAsSmoothStreamingMediaElementDimhandlerAsRoutedEventHandlerAddHandler instance.MediaEnded, handler
```

``` csharp
public event RoutedEventHandlerMediaEnded
```

``` c++
public:
 eventRoutedEventHandler^ MediaEnded {
