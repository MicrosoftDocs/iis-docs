...
``` vb
'Declaration
PublicSharedReadOnlyPipModePropertyAsDependencyProperty
'Usage
DimvalueAsDependencyPropertyvalue = SmoothStreamingMediaElement.PipModeProperty
```

``` csharp
publicstaticreadonlyDependencyPropertyPipModeProperty
```

``` c++
public:
staticinitonlyDependencyProperty^ PipModeProperty
```

``` jscript
publicstaticfinalvarPipModeProperty : DependencyProperty
```
