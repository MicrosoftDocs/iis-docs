...
``` vb
'Declaration
PublicSharedReadOnlySourcePropertyAsDependencyProperty
'Usage
DimvalueAsDependencyPropertyvalue = SmoothStreamingMediaElement.SourceProperty
```

``` csharp
publicstaticreadonlyDependencyPropertySourceProperty
```

``` c++
public:
staticinitonlyDependencyProperty^ SourceProperty
```

``` jscript
publicstaticfinalvarSourceProperty : DependencyProperty
```
