...
``` vb
'Declaration
PublicSharedReadOnlyStretchPropertyAsDependencyProperty
'Usage
DimvalueAsDependencyPropertyvalue = SmoothStreamingMediaElement.StretchProperty
```

``` csharp
publicstaticreadonlyDependencyPropertyStretchProperty
```

``` c++
public:
staticinitonlyDependencyProperty^ StretchProperty
```

``` jscript
publicstaticfinalvarStretchProperty : DependencyProperty
```
