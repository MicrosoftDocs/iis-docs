...
``` vb
'Declaration
PublicPropertyVolumeAsDouble
'Usage
DiminstanceAsSmoothStreamingMediaElementDimvalueAsDoublevalue = instance.Volume
...
``` jscript
function getVolume () : doublefunction setVolume (value : double)
```
