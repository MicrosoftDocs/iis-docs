...
``` vb
'Declaration
PublicClassSSMELogReadyRoutedEventArgs
'Usage
DiminstanceAsSSMELogReadyRoutedEventArgs
```
...
``` c++
publicref classSSMELogReadyRoutedEventArgs
```

``` jscript
publicclass SSMELogReadyRoutedEventArgs
```
