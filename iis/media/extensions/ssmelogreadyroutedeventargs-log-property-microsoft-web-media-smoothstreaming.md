...
``` vb
'Declaration
PublicPropertyLogAsString
'Usage
DiminstanceAsSSMELogReadyRoutedEventArgsDimvalueAsStringvalue = instance.Log
```
...
``` jscript
function getLog () : Stringprivatefunction setLog (value : String)
```
