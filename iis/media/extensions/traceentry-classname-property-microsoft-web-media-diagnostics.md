...
``` vb
'Declaration
PublicPropertyClassNameAsString
'Usage
DiminstanceAsTraceEntryDimvalueAsStringvalue = instance.ClassName
...
``` jscript
function getClassName () : Stringfunction setClassName (value : String)
```
