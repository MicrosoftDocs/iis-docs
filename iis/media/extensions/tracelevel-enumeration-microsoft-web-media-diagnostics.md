...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.web.media.diagnostics.tracelevel(v=VS.90)
ms:contentKeyID: 23961085
ms.date: 05/02/2012
...
``` vb
'Declaration
PublicEnumerationTraceLevel
'Usage
DiminstanceAsTraceLevel
```

``` csharp
publicenumTraceLevel
```

``` c++
publicenum classTraceLevel
```

``` jscript
publicenum TraceLevel
```
