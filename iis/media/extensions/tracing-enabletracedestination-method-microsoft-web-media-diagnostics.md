...
``` vb
'Declaration
PublicSharedSubEnableTraceDestination ( _
    destinationAsTraceDestination _
)
'Usage
DimdestinationAsTraceDestinationTracing.EnableTraceDestination(destination)
```

``` csharp
publicstaticvoidEnableTraceDestination(
...
``` c++
public:
staticvoidEnableTraceDestination(
    TraceDestinationdestination
)
```

``` jscript
publicstaticfunctionEnableTraceDestination(
