...
``` vb
'Declaration
PublicSharedIncludeMethodNameAsBoolean
'Usage
DimvalueAsBooleanvalue = Tracing.IncludeMethodNameTracing.IncludeMethodName = value
```

``` csharp
publicstaticboolIncludeMethodName
```

``` c++
public:
staticboolIncludeMethodName
```

``` jscript
publicstaticvarIncludeMethodName : boolean
```
