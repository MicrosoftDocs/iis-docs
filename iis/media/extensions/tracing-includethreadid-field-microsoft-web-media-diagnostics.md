...
``` vb
'Declaration
PublicSharedIncludeThreadIdAsBoolean
'Usage
DimvalueAsBooleanvalue = Tracing.IncludeThreadIdTracing.IncludeThreadId = value
```

``` csharp
publicstaticboolIncludeThreadId
```

``` c++
public:
staticboolIncludeThreadId
```

``` jscript
publicstaticvarIncludeThreadId : boolean
```
