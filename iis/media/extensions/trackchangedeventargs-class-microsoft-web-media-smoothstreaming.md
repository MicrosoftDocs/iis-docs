...
``` vb
'Declaration
PublicClassTrackChangedEventArgs _
    InheritsEventArgs
'Usage
DiminstanceAsTrackChangedEventArgs
```

``` csharp
publicclassTrackChangedEventArgs : EventArgs
```

``` c++
publicref classTrackChangedEventArgs : publicEventArgs
```

``` jscript
publicclass TrackChangedEventArgs extendsEventArgs
```
