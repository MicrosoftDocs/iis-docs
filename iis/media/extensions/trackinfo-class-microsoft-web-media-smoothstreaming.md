...
``` vb
'Declaration
PublicClassTrackInfo _
    ImplementsIComparable
'Usage
DiminstanceAsTrackInfo
```

``` csharp
publicclassTrackInfo : IComparable
```

``` c++
publicref classTrackInfo : IComparable
```

``` jscript
publicclass TrackInfo implementsIComparable
```
...
<td>Writes a TrackInfo object to string. (Overrides <a href="https://msdn.microsoft.com/en-us/library/7bxwbwt2(v=vs.90)">Object. . :: . .ToString() () () ()</a>.)</td>
</tr>
</tbody>
</table>
