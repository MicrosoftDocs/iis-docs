...
ms:mtpsurl: https://msdn.microsoft.com/en-us/library/microsoft.web.media.smoothstreaming.trackinfo_methods(v=VS.95)
ms:contentKeyID: 46307610
ms.date: 05/31/2012
...
<td>Writes a <a href="trackinfo-class-microsoft-web-media-smoothstreaming_1.md">TrackInfo</a> object to string. (Overrides <a href="https://msdn.microsoft.com/en-us/library/7bxwbwt2(v=vs.95)">Object.ToString()</a>.)</td>
</tr>
</tbody>
</table>
