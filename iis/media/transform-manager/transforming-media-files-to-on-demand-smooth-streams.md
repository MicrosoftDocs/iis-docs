...
- You can add the default **Robocopy** task in Transform Manager to your job template in order to copy the transformed Smooth Streaming output to a Web server running [IIS Smooth Streaming](../../../downloads/microsoft/smooth-streaming.md) or to network-attached storage. For more information, see [Chaining the Robocopy Task to your Transformed Output](chaining-the-robocopy-task-to-your-transformed-output.md).
