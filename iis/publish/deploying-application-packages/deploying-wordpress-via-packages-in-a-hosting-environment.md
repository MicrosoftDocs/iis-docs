...
[![Screenshot of a command window. The directory path is found at the top of the window.](deploying-wordpress-via-packages-in-a-hosting-environment/_static/image42.jpg)](deploying-wordpress-via-packages-in-a-hosting-environment/_static/image41.jpg)
...
2. Click the **Dedicated MySQL Server Machine** option button, and click **Next**.[![Screenshot of the My S Q L Server Instance Configuration Wizard dialog box. The option for the Dedication My S Q L Server Machine is selected.](deploying-wordpress-via-packages-in-a-hosting-environment/_static/image46.jpg)](deploying-wordpress-via-packages-in-a-hosting-environment/_static/image45.jpg)
