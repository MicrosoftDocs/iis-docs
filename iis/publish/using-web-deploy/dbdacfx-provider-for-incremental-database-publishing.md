...
Dacpac Framework supports a lot of different settings and options that you can apply on the dacpac files. A list and explanation of all the options can be found in the [DacDeployOptions Class](/dotnet/api/microsoft.sqlserver.dac.dacdeployoptions).  
