...
| REQUEST_FLAGS         | The Flags of [HTTP_REQUEST](/windows/win32/api/http/ns-http-http_request_v1).<br/>For example, the `HTTP_REQUEST_FLAG_HTTP2` flag will be set for HTTP/2 requests. |
