...
#### Parameters  
 `pProvider`  
 [IN] A pointer to an [IHttpApplicationStopProvider](../../web-development-reference\webdev-native-api-reference/ihttpapplicationprovider-interface.md) interface.  
  
> [!NOTE]
>  The `IHttpApplicationStopProvider` interface is a type definition of an [IHttpApplicationProvider](../../web-development-reference\webdev-native-api-reference/ihttpapplicationprovider-interface.md) interface.  
...
## Remarks  
 When a global module has registered for the [GL_APPLICATION_STOP](../../web-development-reference\webdev-native-api-reference/request-processing-constants.md) event notification, IIS will call the module's `OnGlobalApplicationStop` method when IIS shuts down an application.  
  
> [!NOTE]
>  Global modules can register for the `GlobalApplicationStop` event notification by registering for `GL_APPLICATION_STOP` in the module's [RegisterModule](../../web-development-reference\webdev-native-api-reference/pfn-registermodule-function.md) function.  
...
## See Also  
 ...
 [CGlobalModule::OnGlobalApplicationStart Method](../../web-development-reference\webdev-native-api-reference/cglobalmodule-onglobalapplicationstart-method.md)