...
description: The IAppHostConfigException::FileName Property gets the physical path of the configuration file that caused the current exception to be thrown.  
ms.date: "10/07/2016"
