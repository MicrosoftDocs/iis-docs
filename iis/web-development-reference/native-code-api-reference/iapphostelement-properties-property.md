...
#### Parameters  
 `ppProperties`  
 A pointer to a pointer for an [IAppHostPropertyCollection](../../web-development-reference\webdev-native-api-reference/iapphostpropertycollection-interface.md) interface.  
