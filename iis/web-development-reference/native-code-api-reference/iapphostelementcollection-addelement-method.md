...
#### Parameters  
 `pElement`  
 A pointer to an [IAppHostElement](../../web-development-reference\webdev-native-api-reference/iapphostelement-interface.md) interface.  
...
## See Also  
 ...
 [IAppHostElementCollection::CreateNewElement Method](../../web-development-reference\webdev-native-api-reference/iapphostelementcollection-createnewelement-method.md)