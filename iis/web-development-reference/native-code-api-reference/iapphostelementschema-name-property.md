...
#### Parameters  
 `pbstrName`  
 A pointer to a `BSTR` that contains the name of the current [IAppHostElementSchema](../../web-development-reference\webdev-native-api-reference/iapphostelementschema-interface.md) interface.  
