...
#### Parameters  
 `pbstrName`  
 A pointer to a `BSTR` that contains the name of the current [IAppHostPropertySchema](../../web-development-reference\webdev-native-api-reference/iapphostpropertyschema-interface.md) interface.  
