...
1.  Registers for the [GL_APPLICATION_START](../../web-development-reference\webdev-native-api-reference/request-processing-constants.md) notification.  
  
2.  Creates a [CGlobalModule](../../web-development-reference\webdev-native-api-reference/cglobalmodule-class.md) class that contains an [OnGlobalApplicationStart](../../web-development-reference\webdev-native-api-reference/cglobalmodule-onglobalapplicationstart-method.md) method. This method performs the following tasks:  
  
    1.  Retrieves an `IHttpApplication` interface by using the `GetApplication` method.  
  
    2.  Retrieves the physical path of the current context's application by using the [IHttpApplication::GetApplicationPhysicalPath](../../web-development-reference\webdev-native-api-reference/ihttpapplication-getapplicationphysicalpath-method.md) method.  
