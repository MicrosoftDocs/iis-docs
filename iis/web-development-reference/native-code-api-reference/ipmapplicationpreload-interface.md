...
|Name|Description|  
|----------|-----------------|  
|[IPmApplicationPreload::PreloadApplication](../../web-development-reference\webdev-native-api-reference/ipmapplicationpreload-preloadapplication.md)|Preloads an application into server memory given its site ID and configuration file path.|  
