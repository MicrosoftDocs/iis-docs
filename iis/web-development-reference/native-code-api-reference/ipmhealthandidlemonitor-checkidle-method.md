...
ms.date: 10/07/2016
description: The IPmHealthAndIdleMonitor::CheckIdle Method enables the worker process framework to request whether all the listener channels for a protocol manager are idle.
