...
|[GetCustomInterface](../../web-development-reference\webdev-native-api-reference/iprotocolmanager-getcustominterface-method.md)|Retrieves a custom interface from a protocol manager.|  
|[GetPmInterface](../../web-development-reference\webdev-native-api-reference/iprotocolmanager-getpminterface-method.md)|Retrieves a defined interface from a protocol manager.|  
...
|[Shutdown](../../web-development-reference\webdev-native-api-reference/iprotocolmanager-shutdown-method.md)|Shuts down a protocol manager.|  
