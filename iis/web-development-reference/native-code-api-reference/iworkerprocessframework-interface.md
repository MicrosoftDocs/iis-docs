...
|[GetCustomInterface](../../web-development-reference\webdev-native-api-reference/iworkerprocessframework-getcustominterface-method.md)|Retrieves a custom interface from the worker process framework.|  
|[GetInterfaceVersion](../../web-development-reference\webdev-native-api-reference/iworkerprocessframework-getinterfaceversion-method.md)|Returns the worker process framework version.|  
|[GetWpfInterface](../../web-development-reference\webdev-native-api-reference/iworkerprocessframework-getwpfinterface-method.md)|Retrieves a defined interface from the worker process framework.|  
