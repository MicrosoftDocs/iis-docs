...
description: Describes the PFN_WEBHOST_LISTENER_CONFIG_MANAGER_INITIALIZATION_COMPLETED function and details its syntax, parameters, remarks, and requirements.
ms.date: 10/07/2016
