...
- [Web Deploy](../../publish/deploying-application-packages.md) simplifies the deployment, management, and migration of Web applications. It lets administrators enable developers to publish their Web applications and databases to the hosted environment.
...
The [Web server](../web-server-for-shared-hosting.md) runs the Windows Server 2008 Web server role. Windows Server 2008 delivers IIS, which is a unified Web platform that integrates IIS, ASP.NET, and Windows Communication Foundation. It provides the functionality to deploy [multi-tenant (Shared Hosting) offerings](../web-server-for-shared-hosting.md). All Web applications share the Web server resources. The key features and improvements in IIS include the following:
...
Remote Administration is a key feature of the set of [IIS Management and Administration](../../manage/provisioning-and-managing-iis/iis-management-and-administration.md) capabilities. With [IIS Remote Administration](../../manage/remote-administration.md), hosters can empower their customers to manage their Web applications and corresponding database(s) remotely. This is possible because of these key features in IIS:
