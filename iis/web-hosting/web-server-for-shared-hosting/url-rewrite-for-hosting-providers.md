...
![Diagram that shows the events involving U R L Rewrite. A green arrow goes from the User to the cloud, then through the front and back end, and finally to a Web Server Farm.](url-rewrite-for-hosting-providers/_static/image1.jpg)
