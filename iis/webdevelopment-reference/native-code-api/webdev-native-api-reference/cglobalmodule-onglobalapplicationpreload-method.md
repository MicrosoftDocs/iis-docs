...
#### Parameters  
 `pProvider`  
 [IN] A pointer to an [IGlobalApplicationPreloadProvider](../../../webdevelopment-reference\native-code-api\webdev-native-api-reference/iglobalapplicationpreloadprovider-interface.md) interface.  
