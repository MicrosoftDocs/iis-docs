...
#### Parameters  
 `pProvider`  
 [IN] A pointer to an [IPreBeginRequestProvider](../../../webdevelopment-reference\native-code-api\webdev-native-api-reference/iprebeginrequestprovider-interface.md) interface.  
...
## Remarks  
 When a global module has registered for the [GL_PRE_BEGIN_REQUEST](../../../webdevelopment-reference\native-code-api\webdev-native-api-reference/request-processing-constants.md) event notification, IIS will call the module's `OnGlobalPreBeginRequest` method before a request enters the request pipeline.  
  
> [!NOTE]
>  Global modules can register for the `GlobalPreBeginRequest` event notification by registering for `GL_PRE_BEGIN_REQUEST` in the module's [RegisterModule](../../../webdevelopment-reference\native-code-api\webdev-native-api-reference/pfn-registermodule-function.md) function.  
