...
Gets the configuration system path of the configuration file that this [IAppHostConfigFile](../../../webdevelopment-reference\native-code-api\webdev-native-api-reference/iapphostconfigfile-interface.md) interface represents.  
