...
#### Parameters  
 ...
 `ppConfigFile`  
 A pointer to a pointer for an [IAppHostConfigFile](../../../webdevelopment-reference\native-code-api\webdev-native-api-reference/iapphostconfigfile-interface.md) interface.  
