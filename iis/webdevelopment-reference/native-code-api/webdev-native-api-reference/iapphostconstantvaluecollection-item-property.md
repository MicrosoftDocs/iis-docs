...
#### Parameters  
 ...
 `ppConstantValue`  
 A pointer to a pointer of an [IAppHostConstantValue Interface](../../../webdevelopment-reference\native-code-api\webdev-native-api-reference/iapphostconstantvalue-interface.md) object that contains the constant value.  
