...
Represents a collection of child elements that are nested under the current [IAppHostElement](../../../webdevelopment-reference\native-code-api\webdev-native-api-reference/iapphostelement-interface.md) interface.  
...
#### Parameters  
 `ppElements`  
 A pointer to a pointer for an [IAppHostChildElementCollection](../../../webdevelopment-reference\native-code-api\webdev-native-api-reference/iapphostchildelementcollection-interface.md) interface.  
...
## See Also  
 ...
 [IAppHostElement::Collection Property](../../../webdevelopment-reference\native-code-api\webdev-native-api-reference/iapphostelement-collection-property.md)