...
#### Parameters  
 `ppProperties`  
 A pointer to a pointer for an [IAppHostPropertyCollection](../../../webdevelopment-reference\native-code-api\webdev-native-api-reference/iapphostpropertycollection-interface.md) interface.  
