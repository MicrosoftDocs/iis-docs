...
#### Parameters  
 `ppSchema`  
 A pointer to a pointer for the [IAppHostElementSchema](../../../webdevelopment-reference\native-code-api\webdev-native-api-reference/iapphostelementschema-interface.md) interface that is assigned to the current element.  
