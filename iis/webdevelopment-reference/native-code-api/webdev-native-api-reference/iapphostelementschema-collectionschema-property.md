...
Gets the schema of the collection contained in the corresponding [IAppHostElement Interface](../../../webdevelopment-reference\native-code-api\webdev-native-api-reference/iapphostelement-interface.md) object if the element supports child collections.  
...
#### Parameters  
 `ppCollectionSchema`  
 Contiains an [IAppHostCollectionSchema Interface](../../../webdevelopment-reference\native-code-api\webdev-native-api-reference/iapphostcollectionschema-interface.md)  
...
## See Also  
 ...
 [IAppHostCollectionSchema Interface](../../../webdevelopment-reference\native-code-api\webdev-native-api-reference/iapphostcollectionschema-interface.md)