...
#### Parameters  
 `pbstrType`  
 A pointer to a `BSTR` that contains the type name of the current [IAppHostPropertySchema](../../../webdevelopment-reference\native-code-api\webdev-native-api-reference/iapphostpropertyschema-interface.md) interface.  
