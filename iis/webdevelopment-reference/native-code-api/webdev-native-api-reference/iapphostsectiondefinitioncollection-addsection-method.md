...
#### Parameters  
 ...
 `ppConfigSection`  
 A pointer to a pointer for the newly created [IAppHostSectionDefinition](../../../webdevelopment-reference\native-code-api\webdev-native-api-reference/iapphostsectiondefinition-interface.md) interface.  
...
## See Also  
 [IAppHostSectionDefinitionCollection Interface](../../../webdevelopment-reference\native-code-api\webdev-native-api-reference/iapphostsectiondefinitioncollection-interface.md)