...
#### Parameters  
 ...
 `ppSectionGroup`  
 A pointer to a pointer for the newly created [IAppHostSectionGroup](../../../webdevelopment-reference\native-code-api\webdev-native-api-reference/iapphostsectiongroup-interface.md) interface.  
...
## See Also  
 [IAppHostSectionGroup Interface](../../../webdevelopment-reference\native-code-api\webdev-native-api-reference/iapphostsectiongroup-interface.md)