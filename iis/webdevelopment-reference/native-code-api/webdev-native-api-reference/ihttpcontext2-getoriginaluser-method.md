...
## Return Value  
 A pointer to an [IHttpUser](../../../webdevelopment-reference\native-code-api\webdev-native-api-reference/ihttpuser-interface.md) interface, which can be used to retrieve information about the original user.  
