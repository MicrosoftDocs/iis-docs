...
## Return Value  
 A pointer to an [INamedContextContainer](../../../webdevelopment-reference\native-code-api\webdev-native-api-reference/inamedcontextcontainer-interface.md) interface.  
