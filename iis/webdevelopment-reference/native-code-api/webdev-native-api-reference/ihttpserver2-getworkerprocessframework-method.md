...
#### Parameters  
 ...
 [OUT] Points to the [IWorkerProcessFramework](../../../webdevelopment-reference\native-code-api\webdev-native-api-reference/iworkerprocessframework-interface.md) for the server..  
