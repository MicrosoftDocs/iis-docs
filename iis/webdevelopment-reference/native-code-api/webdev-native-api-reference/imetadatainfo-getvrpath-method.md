...
## Remarks  
 The `GetVrPath` method retrieves a pointer to a string that contains the virtual directory path for the [IMetadataInfo](../../../webdevelopment-reference\native-code-api\webdev-native-api-reference/imetadatainfo-interface.md) interface within the current context.  
