...
|Name|Description|  
|----------|-----------------|  
|[IPmApplicationPreload::PreloadApplication](../../../webdevelopment-reference\native-code-api\webdev-native-api-reference/ipmapplicationpreload-preloadapplication.md)|Preloads an application into server memory given its site ID and configuration file path.|  
