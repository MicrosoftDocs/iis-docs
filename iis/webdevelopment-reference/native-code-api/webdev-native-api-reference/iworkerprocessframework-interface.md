...
|[GetCustomInterface](../../../webdevelopment-reference\native-code-api\webdev-native-api-reference/iworkerprocessframework-getcustominterface-method.md)|Retrieves a custom interface from the worker process framework.|  
|[GetInterfaceVersion](../../../webdevelopment-reference\native-code-api\webdev-native-api-reference/iworkerprocessframework-getinterfaceversion-method.md)|Returns the worker process framework version.|  
|[GetWpfInterface](../../../webdevelopment-reference\native-code-api\webdev-native-api-reference/iworkerprocessframework-getwpfinterface-method.md)|Retrieves a defined interface from the worker process framework.|  
