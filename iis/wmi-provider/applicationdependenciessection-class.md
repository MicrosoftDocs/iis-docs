...
|Name|Description|  
|----------|-----------------|  
|`ApplicationDependencies`|An array of [ApplicationDependency](../wmi-provider/applicationdependency-class.md) values that represent dependencies between applications and one or more Web service extensions.|  
