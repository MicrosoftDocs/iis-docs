...
|`Element`|(Inherited from `ObjectContainerAssociation`.) A read-only [WorkerProcess](../wmi-provider/workerprocess-class2.md) object that represents a Windows Process Activation Service (WAS) worker process. A key property.|  
...
## See Also  
 ...
 [ProcessModelSettings Class](../wmi-provider/processmodelsettings-class1.md)   
