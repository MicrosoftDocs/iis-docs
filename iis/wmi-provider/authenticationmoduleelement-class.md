...
## Remarks  
 Instances of this class are contained in the `AuthenticationModules` property of the [AuthenticationModulesSection](../wmi-provider/authenticationmodulessection-class1.md) class.  
