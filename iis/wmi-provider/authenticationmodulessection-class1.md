...
|Name|Description|  
|----------|-----------------|  
|`AuthenticationModules`|An array of [AuthenticationModuleElement](../wmi-provider/authenticationmoduleelement-class.md) values that specify types for authentication modules.|  
