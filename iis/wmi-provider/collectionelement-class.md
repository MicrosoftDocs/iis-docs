...
|[BindingElement](../wmi-provider/bindingelement-class1.md)|Represents a binding element for a Web site.|  
...
|[OutputCacheProfile](../wmi-provider/outputcacheprofile-clas.md)|Configures the output cache profile for the pages of a Web application.|  
