...
|Name|Description|  
|----------|-----------------|  
|[ApplicationDependenciesSection](../wmi-provider/applicationdependenciessection-class1.md)|Exposes application dependency information.|  
|[AppSettingsSection](../wmi-provider/appsettingssection-class1.md)|Contains custom application settings, such as file paths, XML Web service URLs, or information that is stored in the .ini file for an application.|  
|[AuthenticationModulesSection](../wmi-provider/authenticationmodulessection-class1.md)|Specifies the authentication modules that conduct the authentication process with a server.|  
|[AuthenticationSection](../wmi-provider/authenticationsection-class1.md)|Configures [!INCLUDE[vstecasp](../wmi-provider/includes/vstecasp-md.md)] authentication.|  
|[AuthorizationSection](../wmi-provider/authorizationsection-class1.md)|Configures authorization for access to URLs.|  
...
|[DefaultDocumentSection](../wmi-provider/defaultdocumentsection-class1.md)|Specifies the Web page file names to serve to clients by default.|  
...
|-----------|--------------|-----------------|  
|[AuthorizationSection](../wmi-provider/authorizationsection-class1.md)|`Authorization`|ASPNET_Schema.xml|  
|[CachingSection](../wmi-provider/cachingsection-class.md)|`Profiles.Profiles`|IIS_Schema.xml|  
|[DefaultDocumentSection](../wmi-provider/defaultdocumentsection-class1.md)|`Files.Files`|IIS_Schema.xml|  
...
## See Also  
 ...
 [AuthorizationSection Class](../wmi-provider/authorizationsection-class1.md)   
