...
|`Files`|A [FileSettings](../wmi-provider/filesettings-class1.md) value that contains the names of the files that the Web server may return to clients by default.|  
