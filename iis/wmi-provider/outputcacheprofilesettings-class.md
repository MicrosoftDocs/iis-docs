...
|Name|Description|  
|----------|-----------------|  
|`OutputCacheProfiles`|An array of [OutputCacheProfile](../wmi-provider/outputcacheprofile-clas.md) values that configure output cache profiles for the pages of a Web application.|  
