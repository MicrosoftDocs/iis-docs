...
|`OutputCacheProfiles`|An [OutputCacheProfileSettings](../wmi-provider/outputcacheprofilesettings-class.md) value that contains cache settings that can be applied to pages to specify the [OutputCache](../wmi-provider/outputcachesection-class.md) directive.|  
...
## See Also  
 ...
 [OutputCacheProfile Class](../wmi-provider/outputcacheprofile-clas.md)   
