...
|Name|Description|  
|----------|-----------------|  
|`Container`|(Inherited from [ObjectContainerAssociation](../wmi-provider/objectcontainerassociation-class1.md).) A read-only [Server](../wmi-provider/server-class1.md) object that represents a Web server running IIS.|  
...
## See Also  
 ...
 [SiteUsesSSLBinding Class](../wmi-provider/siteusessslbinding-class1.md)   
