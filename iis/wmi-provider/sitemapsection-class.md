...
description: This article contains information about syntax, methods, properties, subclasses, inheritence hierarchy, and requirements for the SiteMapSection class.
ms.date: "10/07/2016"
...
|`Providers`|A [ProviderSettings](../wmi-provider/providersettings-class.md) value that contains navigation providers.|  
