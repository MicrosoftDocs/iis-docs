...
|Name|Description|  
|----------|-----------------|  
|`DbProviderFactories`|A [DbProviderFactorySettings](../wmi-provider/dbproviderfactorysettings-class.md) value that contains configuration settings for [!INCLUDE[ado_whidbey_long](../wmi-provider/includes/ado-whidbey-long-md.md)] provider factories.|  
