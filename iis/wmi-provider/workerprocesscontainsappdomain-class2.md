...
|Name|Description|  
|----------|-----------------|  
|`Container`|(Inherited from [ObjectContainerAssociation](../wmi-provider/objectcontainerassociation-class1.md).) A read-only [WorkerProcess](../wmi-provider/workerprocess-class2.md) object that represents an IIS worker process. A key property.|  
